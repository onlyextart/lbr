...
class Contacts extends CActiveRecord {
    ...
    public function search() {
        ...
        $criteria->compare('director_surname', $this->director_surname, true);
        $criteria->compare('director_secondname', $this->director_secondname, true);
        $criteria->compare('director_photo', $this->director_photo, true);
