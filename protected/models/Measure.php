 ...
 * @property TechCharacteristic[] $techCharacteristics
 */
class Measure extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, reduction', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, reduction', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'techCharacteristics' => array(self::HAS_MANY, 'TechCharacteristic', 'measure_id'),
		);
	}
