...
class m130605_084459_add_data_roles_groups_users_RE extends CDbMigration
{
	public function up()
	{
	...
	{
		echo "m130605_084459_add_data_roles_groups_users_RE does not support migration down.\n";
		return false;
	}
