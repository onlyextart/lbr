...
class MightinessController extends Controller
{
    ...
    public function actionAddValues()
    {
        ...
        $stage31->title = 'Ранневесеннее боронование';
        $stage31->save();
        ...
        $stage33->title = 'Внесение пестицидов';
        $stage33->save();
        $stage34 = new TechStage();
        $stage34->title = 'Рыхление подошвы и переуплотненного слоя почвы (раз в 3-5 лет)';
        $stage34->save();
