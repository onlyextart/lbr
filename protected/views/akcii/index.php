...
<div class="right-sidebar">
    ...
    <div id="video_wrapper">
        ...
        <div id="video_text">
            ...
            <p style="white-space:normal" >С мая в сети ЛБР-АгроМаркет действуют скидки на технику к сезону кормозаготовки.<p>
...
<div id="footer-banner">
    ...
    <div class="footer-elem">
        <a href="/selskohozyaystvennaya-tehnika/type/teleskopicheskie-pogruzchiki/dieci/"> 
            <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/akcii/footer_banner2.jpg">
        </a>
    </div>
    <div class="footer-elem">
        <a href="/selskohozyaystvennaya-tehnika/type/opryskivateli/"> 
            <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/akcii/footer_banner3.jpg">
        </a>
    </div>
</div>
