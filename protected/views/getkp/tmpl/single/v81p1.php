                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/81-diamond/diamond.jpg" width="760" height="320px" style="border: 0; float: left;" alt="Логотип GreatPlains">
                                </td>
                            </tr>
                                ...
                                <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    <tr valign="top">                                                        
                                                        <td colspan="2" style="width: 160px; padding: 17px 0 0 10px;">
                                                            ...
                                                            <img src="http://www.lbr.ru/images/kp/81-diamond/diamond2.jpg" width="368" height="355" style="border: 0; float: left;" alt="Картинки не отображаются">
