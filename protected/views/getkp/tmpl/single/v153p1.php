                                                    ...
                                                    <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                        <tr>
                                                            <td width="170" valign="top">
                                                                ...
                                                                <p style="margin:0; color:black; padding: 5px 0px 0px 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify;">
                                                                    Уборка лука с валка морковоуборочным ком-байном с помощью дополнительной опции.
                                                                </p>  
                                                            </td>
                                                            <td width="208" style="padding:0px 0px 0px 10px;">
                                                                <img src="http://www.lbr.ru/images/kp/153-simon/mail-3.jpg" width="198" style="border: 0; float: right;" alt="Изображения не отображаются">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td width="170" valign="top">
                                                                ...
                                                                <p style="margin:0; color:black; padding: 5px 0px 0px 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify;">
                                                                    Обрезное устройство
                                                                    (расположенное в
                                                                    верх-ней части подъёмного устройства)
                                                                    срезает ботву моркови. Обрезная ботва выбрасывается на
                                                                    поле, а морковь падает на транспортер, который доставляет ее в
                                                                    грузовик.</p>  
                                                            </td>
                                                            <td width="188" style="padding:0px 0px 0px 10px;">
                                                                <img src="http://www.lbr.ru/images/kp/153-simon/mail-4.jpg" width="178" style="border: 0; float: right;" alt="Изображения не отображаются">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
