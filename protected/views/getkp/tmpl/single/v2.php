...
<table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; page-break-after: always;">
    <tbody>
        <tr valign="top">
            <td colspan="3"><img src="http://www.lbr.ru/images/kp/top-line.png" style="display: block;"/></td>
        </tr>
        <tr>
            <td><img width="11" height="1072" src="http://www.lbr.ru/images/kp/left-line.png" style="display: block;"/></td>
            <td>                   
                <table style="border-collapse: collapse;" width="616" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
                                    ...
                                    <tr>
                                        <td><img src="http://www.lbr.ru/images/kp/akzent.png" alt="Борона Aczent" title="Физика против химии"/></td>
                                    </tr>
                                    <tr>
                                        <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="410" valign="top">
                                                            <table  style="border-collapse: collapse; vertical-align: top;" width="400" cellspacing="0" cellpadding="0" align="left" bgcolor="#FFFFFF">
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-family: Calibri,sans-serif; font-size: 17px; color: #d3232a; font-weight: bold; text-transform: uppercase;">1. БОЛЬШЕ ШИРИНА ЗАХВАТА И СКОРОСТЬ = БОЛЬШЕ ПРОИЗВОДИТЕЛЬНОСТЬ!</span><br/>
                                                                        <span style="font-family: Calibri,sans-serif; font-size: 13px;">Бороны Akzent 9 и Akzent 12 метров агрегатируются с тракторами от 80 л.с. (МТЗ 82).</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-family: Calibri,sans-serif; font-size: 17px; color: #d3232a; font-weight: bold; text-transform: uppercase;">2. ПОБОРОТЬ СОРНЯК В РЯДКЕ!!!</span><br/>
                                                                        <span style="font-family: Calibri,sans-serif; font-size: 13px;">Использование бороны Akzent - единственный способ вычесать сорняк между культурными растениями: борона работает под углом или перпендикулярно рядков пропашных.</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-family: Calibri,sans-serif; font-size: 17px; color: #d3232a; font-weight: bold; text-transform: uppercase;">3. НЕ УБИВАЙТЕ УРОЖАЙ ПОДДЕЛКАМИ!!!</span><br/>
                                                                        <span style="font-family: Calibri,sans-serif; font-size: 13px;">Только оригинальный зуб обеспечивает качественную обработку и бережное отношение к посевам.</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-family: Calibri,sans-serif; font-size: 17px; color: #d3232a; font-weight: bold; text-transform: uppercase;">4. Борона Akzent по праву называется нашими клиентами «неубиваемая»!</span><br/>
                                                                        <span style="font-family: Calibri,sans-serif; font-size: 13px;">Срок службы бороны 5-7 лет при ежегодном объеме работ от 500 га. Оригинальная австрийская закалка зубьев позволяет не менять рабочие органы 3-4 сезона.</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                                        ...
                                                        <td width="196" valign="top"><img src="http://www.lbr.ru/images/kp/akzent2.png" alt="Борона Aczent" title="Физика против химии" style="display: block;"/><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/><img src="http://www.lbr.ru/images/kp/akzent3.png" alt="Борона Aczent" title="Физика против химии" style="display: block;"/></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
            ...
            <td><img width="11" height="1072" src="http://www.lbr.ru/images/kp/right-line.png" style="display: block;"/></td>
        </tr>
        <tr valign="bottom">
            <td colspan="3"><img src="http://www.lbr.ru/images/kp/bot-line.png" style="display: block;"/></td>
        </tr>
    </tbody>
</table>
</body>
