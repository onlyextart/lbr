                    ...
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                    <td width="328">                                        
                                    <span style="font-family: Calibri, sans-serif; font-size: 16px; font-weight: bolder; color: #d1232a; text-transform: uppercase;">1. 2 в 1, лучшие качества от прицепных и навесных разбрасывателей!<br /></span>
                                    ...
                                    <span style="font-family: Calibri, sans-serif; font-size: 16px; font-weight: bolder; color: #d1232a; text-transform: uppercase;">2. Уникальность в продуманности!<br /></span>
                                     <span style="display: block; text-align: justify; font-family:Calibri, sans-serif; font-size: 14px; color: #222222; margin: 10px 0; line-height: 16px;">
                                    ...
                                    <span style="font-family: Calibri, sans-serif; font-size: 16px; font-weight: bolder; color: #d1232a; text-transform: uppercase;">3. Платить за название или за качество?!<br /></span>
                                     <span style="display: block; text-align: justify; font-family:Calibri, sans-serif; font-size: 14px; color: #222222; margin: 10px 0; line-height: 16px;">
                                        ...
                                        • Разбрасыватели ни чем, не уступают в равномерности и надёжности таким грандам как Amazone, RAUH или Sulky. <b>Выигрыш в цене составляет не менее 30%!</b><br />
                                    </span>  
                                                                      
                                     
                                    </td>
                                    <td><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    <td align="right"><img src="http://www.git-lbr.ru/images/kp/kastor.jpg" width="300" border="0" />
