...
<body style="min-height: 100%;">
    ...
    <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px;">
        <tr align="right">
            <td><span style="font-family: Calibri, sans-serif; font-size:32px; font-weight: bolder; color: #d1232a;">Профессиональная уборка лука!!</span></td>
        </tr>
            ...
            <td>
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    ...
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr><img src="http://www.lbr.ru/images/kp/yborka-luka.jpg" width="638" border="0" />
                                   ...
                                   Лезвия, используемые на обрезчике ботвы двухсторонние. При стачивании одной стороны, можно легко использовать другую просто перевернув лезвие.
                                     ...
                                     <table width="328" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Колеса, мм</span></td>
                                                <td style="text-align: center;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">512 x144</span></td>
                                             </tr>
                                             <tr>
                                    ...
                                    <td align="right"><img src="http://www.lbr.ru/images/kp/yborka-luka1.jpg" width="300" border="0" />
                                    <img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/><img src="http://www.lbr.ru/images/kp/yborka-luka2.jpg" width="300" border="0" />
                                    </td>
                                   ...
                                   Шаг цепи транспортера 44 мм. Длина транспортера 2000 м с перепадами для очистки лука от грязи.
                                     ...
                                     <table width="328" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            <tr style="background-color: #d1d3d4;">
                                                <td style="text-align: left;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong>&nbsp;Модель</strong></span></td>
                                                <td style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong><strong>Копалка 1,5 м</strong></strong></span></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">&nbsp;Рабочая ширина, м</span></td>
                                                <td><span style="font-family: Calibri, sans-serif; font-size: 12px;">1,5</span></td>
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">&nbsp;Колеса, мм</span></td>
                                                <td style="text-align: center;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">420x185</span></td>
                                             </tr>
                                             <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">&nbsp;Требуемая мощность трактора, л.с.</span></td>
                                    ...
                                    <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    <td align="right"><img src="http://www.lbr.ru/images/kp/yborka-luka4.jpg" width="300" border="0" />
                                    <img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/><img src="http://www.lbr.ru/images/kp/yborka-luka5.jpg" width="300" border="0" />
                                    </td>
                                   ...
                                   Именно поэтому для работы комбайна достаточно трактора малой мощности.
                                     ...
                                     <table width="328" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            <tr style="background-color: #d1d3d4;">
                                                <td style="text-align: left;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong>&nbsp;Модель</strong></span></td>
                                                <td style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong><strong>СHO</strong></strong></span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><span style="font-family: Calibri, sans-serif; font-size: 12px;">Свыше 25</span></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    <td align="right"><img src="http://www.lbr.ru/images/kp/yborka-luka6.jpg" width="300" border="0" />                                    
                                    </td>
