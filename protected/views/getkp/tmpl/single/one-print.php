...
<body style="height: 1200px; width: 800px;">
...
<table width="800" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px;">
    <tbody>
        <tr valign="top">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="410" valign="top">
                                                            <table  style="border-collapse: collapse; vertical-align: top;" width="400" cellspacing="0" cellpadding="0" align="left" bgcolor="#FFFFFF">
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-family: FuturisXC, Calibri,sans-serif; font-size: 16px; color: #d3232a; font-weight: bold; text-transform: uppercase;">1. БОЛЬШЕ ШИРИНА ЗАХВАТА И СКОРОСТЬ = БОЛЬШЕ ПРОИЗВОДИТЕЛЬНОСТЬ!</span><br/>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-family: FuturisXC, Calibri,sans-serif; font-size: 16px; color: #d3232a; font-weight: bold; text-transform: uppercase;">2. ПОБОРОТЬ СОРНЯК В РЯДКЕ!!!</span><br/>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-family: FuturisXC, Calibri,sans-serif; font-size: 16px; color: #d3232a; font-weight: bold; text-transform: uppercase;">3. НЕ УБИВАЙТЕ УРОЖАЙ ПОДДЕЛКАМИ!!!</span><br/>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-family: FuturisXC, Calibri,sans-serif; font-size: 16px; color: #d3232a; font-weight: bold; text-transform: uppercase;">4. Борона Akzent по праву называется нашими клиентами «неубиваемая»!</span><br/>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="border: 1px solid #808285; background: #d1d3d4; text-align: center; width: 40%;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 12px; font-weight: bold;">Модель</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; background: #d1d3d4; text-align: center; width: 20%;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 12px; font-weight: bold;">Akzent 9</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; background: #d1d3d4; text-align: center; width: 20%;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 12px; font-weight: bold;">Akzent 12</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; background: #d1d3d4; text-align: center; width: 20%;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 12px; font-weight: bold;">Akzent 12<br/>ПРОФИ*</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="border: 1px solid #808285; width: 40%;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 11px;">&nbsp;&nbsp;Масса, кг</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 11px;">&nbsp;&nbsp;870</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 11px;">&nbsp;&nbsp;1100</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 11px;">&nbsp;&nbsp;1100</span>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="border: 1px solid #808285; width: 40%;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 11px;">&nbsp;&nbsp;Требуемая мощность, л.с.</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 11px;">&nbsp;&nbsp;80-90</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 11px;">&nbsp;&nbsp;100-110</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 11px;">&nbsp;&nbsp;100-110</span>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="border: 1px solid #808285; width: 40%;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 14px;">&nbsp;&nbsp;Цена, тыс.руб.</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 14px; font-weight: bold;">&nbsp;&nbsp;1133</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 14px; font-weight: bold;">&nbsp;&nbsp;1000</span>
                                                                                    </td>
                                                                                    <td style="border: 1px solid #808285; width: 20%; text-align: center;">
                                                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 14px; font-weight: bold;">&nbsp;&nbsp;11111</span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                        ...
                                        <td>
                                            <table style="border-collapse: collapse;" width="600" cellspacing="0" cellpadding="0" align="left" bgcolor="#FFFFFF">
                                                <tr>
                                                    <td width="10"><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                                    <td>
                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 14px; font-weight: bold;">Ждем Вас в филиале ЛБР-АгроМаркет (Барнаул)!</span><br>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                                    <td>
                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 14px; font-weight: bold;">Время работы: 8.00-17.00</span><br>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                                    <td>
                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 14px; font-weight: bold;">Адрес филиала: 656067 Барнаул, ул. Попова, 216</span><br>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                                    <td>
                                                        <span style="font-family: FuturisC, Calibri, sans-serif; font-size: 14px; font-weight: bold;">Телефоны: +7 (3852) 60-17-33, +7(3852)29-9870, 29-9871, 29-9872, 29-9873</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
