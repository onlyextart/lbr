                                                            ...
                                                            <? 
                                                                ...
                                                                foreach ($small as $img)
                                                                {
                                                                    if($img=='br')
                                                                        ...
                                                                        echo '<img width="190" src="http://www.git-lbr.ru'.$img.'" style="display: block; max-height: 100px;"/>';
