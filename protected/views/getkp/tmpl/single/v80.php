                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white; border-bottom: 2px solid black;">
                            <tr>
                                <td style="padding-bottom: 3px;">
                                    <!-- Заголовок -->
                                    <a href="http://www.lbr.ru/tehnika/shirokozakhvatnye-tekhnologii-pochvoobrabotki-i-seva/shirokozakhvatnye-seyalki/266-mekhanicheskie-seyalki-nulevogo-tsikla-cph-2000f/" style="font-size: 18px; font-weight: 800; font-family: 'Arial Black', Arial; text-decoration: none; color: black;">
                                        Механическая дисковая сеялка СPH-2000F
                                    </a>
                                </td>
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/80-2000f/2000f.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                                ...
                                <td width="380">
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr valign="top">
                                            ...
                                            <td style="padding: 17px 20px 0 0; ">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; color: black; text-align: justify; ">
                                                    <span style="font-family: 'Trebuchet MS', sans-serif; font-size: 16px; font-weight: bold; font-style: italic; color: #F58220; ">No-Till и минимальная технологии обработки почвы
                                                </p>                                                
                                            </td>
                                        </tr>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td style="padding: 17px 0 0 0; vertical-align: middle;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; color: black; text-align: justify; ">
                                                    <span style="font-family: 'Trebuchet MS', sans-serif; font-size: 16px; font-weight: bold; font-style: italic; color: black; text-align: center; ">Максимальное время в работе</span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td style="padding: 17px 0 0 0; vertical-align: middle;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; color: black; text-align: justify; ">
                                                    <span style="font-family: 'Trebuchet MS', sans-serif; font-size: 16px; font-weight: bold; font-style: italic; color: black; text-align: center; ">Долговечность конструкции</span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td style="padding: 10px 10px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify; color: black; ">
                                                   Высевающие аппараты работают максимально точно, а высевающие катушки (эксклюзивная конструкция от Great Plains) поддерживают равномерный посев вне зависимости от рабочей скорости движения при посеве.
                                                </p>
                                            </td>
                                            <td style="padding: 10px 0 0 0; text-align: right; vertical-align: middle;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f2.jpg" width="150" style="border: 0; float: right;"  alt="Картинки не отображаются">
                                            </td>
                                            </tr>
                                            </table>
                                             </td>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td style="padding: 10px 10px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify; color: black; ">
                                                   Превосходное качество разрезания грунта режущим турбо-диском на заданной глубине. 
                                                   При встрече с препятствием защищает работу дисков пружинный механизм с усилием 204 кг. 
                                                   Двухдисковые сошники со смещенными осями создают идеальную борозду при минимальном сопротивлении.
                                                </p>
                                            </td>
                                            <td style="padding: 10px 0 0 0; vertical-align: middle; text-align: right;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f3.jpg" width="150" style="border: 0; float: right;"  alt="Картинки не отображаются">
                                            </td>
                                            </tr>
                                            </table>
                                             </td>
                                    ...
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td style="padding: 5px 0px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black; ">
                                                    Т-образная рукоятка регулирует глубину сева
                                                </p>
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            ...
                                            <td style="padding: 10px 15px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify; color: black; ">
                                                   Контроль посева. Счетчик гектаров контролирует засеянную площадь.
                                                </p>                                                
                                            </td>
                                            <td rowspan="2" style="padding: 10px 0 0 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f3.jpg" width="160" style="border: 0; float: left;"  alt="Картинки не отображаются">
                                            </td>
                                            </tr>
                                            <tr valign="top">
                                            <td style="padding: 10px 15px 0 0;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 10px 0 15px 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; color: #f58220; ">
                                                    Внесение сухих минеральных удобрений при посеве.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr valign="top">                                                        
                                             <td colspan="2" style="padding: 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; color: black; text-align: justify; ">
                                                    <span style="font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; color: #F58220;">Хорошо видимый измеритель глубины</span>
                                                    <span style="font-family: 'Trebuchet MS', sans-serif; font-size: 13px; color: black;"> дает возможность регулировать и контролировать глубину работы режущих дисков прямо из кабины трактора.</span>
                                                </p>
                                            </td>
                                        </tr>                                          
                                        <tr valign="top">                                            
                                            <td colspan="2" style="padding: 10px 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f4.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                            </td>
                                        </tr>
                ...
                <!-- Ссылка-кнопка подробнее -->
                    <?php
                        Yii::app()->getController()->renderPartial('tmpl/template/mail_more_button', 
                                array(
                                    'link' => 'http://www.lbr.ru/tehnika/shirokozakhvatnye-tekhnologii-pochvoobrabotki-i-seva/shirokozakhvatnye-seyalki/266-mekhanicheskie-seyalki-nulevogo-tsikla-cph-2000f/',
                                    'colspan' => false,
                                    ...
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td colspan="2" style="padding: 0 0 5px;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Превосходное копирование рельефа поля</span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr valign="top"> 
                                            <td colspan="2" style="padding: 0 0 5px;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black; ">
                                                    Конструкция поворотной рамы, обеспечивает полное копирование рельефа на неровных поверхностях и косогорах. 
                                                    Сеялка движется постоянно вслед за режущими дисками даже при поворотах.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr valign="top">                                            
                                            <td colspan="2" style="padding: 10px 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f5.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                            </td>
                                        </tr>
                                       <tr>
                                            <td colspan="2" style="padding: 0 0 5px;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Приводное копирующее колесо</span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr valign="top"> 
                                            <td colspan="2" style="padding: 0 0 5px;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black; ">
                                                    Привод высевающих аппаратов прост и не требует никаких выключателей.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr valign="top">                                            
                                            <td colspan="2" style="padding: 10px 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f7.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                            </td>
                                        </tr>
                                        <tr valign="top">    
                        ...
                        <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="right" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="40%" style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4;">CPH-2000F</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">17,78</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">4410</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">6,1</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">2,5</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">1742</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">41-82/204</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">от 165</td>
                                </tr>
                                <tr>
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Цена с НДС<span style="color:#cc3333; font-size:12px;">*</span></td>
                                ...
                                <td width="380" style="padding-left: 10px;">
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td colspan="2" style="padding: 0 0 5px;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Маркеры</span> имеют достаточный вес для разрезания са-
мых тяжелых растительных остатков.
                                                </p>
                                            </td>
                                        </tr>                                        
                                        <tr valign="top">                                            
                                            <td colspan="2" style="padding: 5px 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f6.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            <td colspan="2" style="padding: 0 0 5px;">
                                        ...
                                        <tr valign="top"> 
                                            <td colspan="2" style="padding: 0 0 5px;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black; ">
                                                    В сеялке Great Plains есть дополнительное отверстие на крепление сошника, которое позволяет переставлять
сам сошник ниже.
                                                </p>
                                            </td>
                                        </tr> 
                                        <tr valign="top">                                            
                                            <td colspan="2" style="padding: 3px 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f8.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                            </td>
                                        </tr> 
                                        <tr valign="top">                                            
                                            <td colspan="2" style="padding: 3px 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f9.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                            </td>
                                        </tr> 
                                         <tr valign="top">                                            
                                            <td colspan="2" style="padding: 3px 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f10.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                            </td>
                                        </tr>    
                                         <tr valign="top">                                            
                                            <td colspan="2" style="padding: 3px 0;">
                                                <img src="http://www.lbr.ru/images/kp/80-2000f/2000f11.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                            </td>
                                        </tr>                                                                             
                                    </table>
