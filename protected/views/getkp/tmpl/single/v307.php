                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/307-bdm5-7/1.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td width="300" style="padding: 0px 0px 0px 10px;">
                                    <img src="http://www.lbr.ru/images/kp/307-bdm5-7/2.jpg" width="290" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                                    ...
                                    <table width="440" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr valign="top">
                                            <td width="50" style="padding: 2px 0px 0px 0px;">
                                                <img src="http://www.lbr.ru/images/kp/307-bdm5-7/marker_ok.jpg" width="50" style="border: 0; float: left;" alt="Изображения не отображаются">
                                            </td>
                ...
                <tr>
                    <td style="padding: 15px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td width="30">
                                    <img src="http://www.lbr.ru/images/kp/307-bdm5-7/marker.jpg" width="30" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            ...
                            <tr valign="top">
                                <td width="380" align="center" style="padding: 5px 0px 0px 0px; border-top:2px solid #5c5853; border-right:2px solid #5c5853;">
                                    <table width="380" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                                        ...
                                        <tr valign="top">
                                            <td>
                                                <img src="http://www.lbr.ru/images/kp/307-bdm5-7/3.jpg" width="360" style="border: 0;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            <td style="padding:0px 10px 0px 30px;">
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal;text-align: justify; ">
                                                    Возможность присоединения отъемных крыльев
                                                    до ширины захвата - 7м
                                                </p>
                                            </td>
                                        </tr>
                                     </table>
                                ...
                                <td width="380" align="center" style="padding: 5px 0px 0px 0px; border-top:2px solid #5c5853;">
                                    <img src="http://www.lbr.ru/images/kp/307-bdm5-7/4.jpg" width="120" style="border: 0;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                             <tr valign="top">
                                <td width="380" align="center" style="padding: 5px 10px 0px 0px; border-right:2px solid #5c5853;border-bottom:2px solid #5c5853;">
                                   <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr valign="top">
                                            <td width="20">
                                                <img src="http://www.lbr.ru/images/kp/307-bdm5-7/marker_red.jpg" width="20" style="border: 0; float: left;" alt="Изображения не отображаются">
                                            </td>
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border:0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td width="180" rowspan="2" style="padding: 0px 10px 10px 0px; border-bottom:2px solid #5c5853;">
                                    <img src="http://www.lbr.ru/images/kp/307-bdm5-7/5.jpg" width="150" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                ...
                                <td width="350" align="center" style="padding: 0px 0px 0px 0px;">
                                    <img src="http://www.lbr.ru/images/kp/307-bdm5-7/6.jpg" width="280" style="border: 0;" alt="Изображения не отображаются">
                               </td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr>
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border:0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td width="180" rowspan="2" style="padding: 0px 10px 10px 0px; ">
                                    <img src="http://www.lbr.ru/images/kp/307-bdm5-7/7.jpg" width="150" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                                <td width="580" style="padding: 0px 0px 0px 0px;">
                                    <table width="580" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr valign="top">
                                    ...
                                    <table width="580" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                                        ...
                                        <tr valign="top">
                                           <td width="520" style="padding:3px 0px 0px 10px;">
                                                <img src="http://www.lbr.ru/images/kp/307-bdm5-7/m1.jpg" width="25" style="border: 0; float: left;margin-right:3px;" alt="Изображения не отображаются">
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal;text-align: justify; ">
                                        ...
                                        <tr valign="top">
                                           <td width="520" style="padding:3px 0px 0px 10px;">
                                                <img src="http://www.lbr.ru/images/kp/307-bdm5-7/m2.jpg" width="25" style="border: 0; float: left; margin-right:3px;" alt="Изображения не отображаются">
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal;text-align: justify; ">
                                        ...
                                        <tr valign="top">
                                           <td width="520" style="padding:3px 0px 0px 10px;">
                                                <img src="http://www.lbr.ru/images/kp/307-bdm5-7/m3.jpg" width="25" style="border: 0; float: left;margin-right:3px;" alt="Изображения не отображаются">
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal;text-align: justify; ">
       ...
       <td style="padding:5px 20px 0px 20px;">
            <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="center" style="padding:0px 0px 0px 20px; border: 0; border-collapse: collapse; background: white;">
                <tr>
                    <td width="760" style="padding: 0px 0px 0px 0px;" valign="top">
                                ...
                                <td>
                                    <table width="700" bgcolor="#FFFFFF" align="center" cellspacing="0" cellpadding="4px" align="center" style="border: solid black 1px; border-collapse: collapse; background-clip:padding-box;">
                                        <tr>
                                            ...
                                            <td width="25%" align="center" style="border: solid black 1px; background-clip:padding-box;"><strong><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">БДМ-5х3ПШК С</span></strong></td>
                                            <td width="25%" align="center" style="border: solid black 1px; background-clip:padding-box;"><strong><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">БДМ-6х3ПШК С</span></strong></td>
                                            <td width="25%" align="center" style="border: solid black 1px; background-clip:padding-box;"><strong><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">БДМ-7х3ПШК С</span></strong></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3" align="center" style="border: solid black 1px;"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">прицепная, модульная</span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center" style="border: solid black 1px;"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">56</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="border: solid black 1px;"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">5,0</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="border: solid black 1px;"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">280</span></td>
                                        </tr>
                                        <tr>
