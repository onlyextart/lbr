                                            ...
                                            <td  style="padding: 5px 0px 0px 0px; text-align: left;">
                                                ...
                                                <table width="308" bgcolor="#FFFFFF" cellspacing="0" cellpadding="1px" align="left" style="border: solid black 1px; border-collapse: collapse; background-clip:padding-box;">
                                                    <tr>
                                                        ...
                                                        <td width="35%" align="center" style="border: solid black 1px; background-clip:padding-box; background-color: #eeeeee;" bgcolor="#eeeeee"><strong><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">КТН-2ВМ</span></strong></td>
                                                     </tr>
                                                    <tr>
                                            ...
                                            <td style="padding: 5px 0px 0px 0px;">
                                                <table width="308" bgcolor="#FFFFFF" align="center" cellspacing="0" cellpadding="1px" align="center" style="border: solid black 1px; border-collapse: collapse; background-clip:padding-box;">
                                                    <tr>
                                                        ...
                                                        <td width="23%" align="center" style="border: solid black 1px; background-clip:padding-box; background-color: #eeeeee;" bgcolor="#eeeeee"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 13px;"><strong> Pyra 1600</strong></span></td>
