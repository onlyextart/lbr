                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/208-mecmar/mail-2.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="padding: 0px 0px 3px 20px;">
                                                <table width="358" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    ...
                                                    <tr>
                                                        <td style="padding: 10px 0px 0px 0px;">
                                                            <img src="http://www.lbr.ru/images/kp/208-mecmar/mail-3.jpg" width="358" style="border: 0; float: right;" alt="Изображения не отображаются">
                                                        </td>
                                                    </tr>
    ...
    <tr>
        <td>
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                <tr><td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            ...
                            <tr valign="top">
                                    ...
                                    <table width="438" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                        ...
                                        <tr>
                                            <td style="padding:5px 0px 10px 0px;">
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight:normal;text-align: justify; ">
                                                    Корпус сушильной камеры изготовлен из перфорированной нержавеющей стали, 
                                                    а все крепежные
                                                    элементы обработаны специальным антикоррозионным составом 
                                                    и обладают высокой прочностью. Срок
                                        ...
                                        <tr>
                                            <td style="padding:5px 0px 10px 0px;">
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight:normal;text-align: justify; ">
                                                    • привод только от ВОМ трактора<br>
                                                    • привод от электросети и ВОМ трактора<br>
                                                    • привод только от электросети.
                                                </p>
                                        ...
                                        <tr>
                                            <td style="padding:10px 0px 10px 0px;">
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight:normal;text-align: justify; ">
                                                    По типу применяемого топлива можно выбрать
                                                    газовую горелку или на жидком топливе.
                                                </p>
                                ...
                                <td valign="top">
                                    <!-- Вторая колонка-->
                                    <table width="322" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                       
                                        <tr>
                                            <td style="padding:10px 0px 0px 20px;">
                                                <img src="http://www.lbr.ru/images/kp/208-mecmar/mail-4.jpg" width="288" style="border: 0; float: right;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                ...
                <tr>
                    <td colspan="2" bgcolor="#F58220" align="center" style="background-color:#F58220; padding: 10px;">
                        <p style="margin:0; color:#FFFFFF; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 24px; font-weight: bold;text-align: centrer; ">
                            Увеличит доход с каждой тонны зерна
                        </p>
                    </td>
                </tr>
                ...
                <tr valign="top">
                    <td colspan="2" style="padding:10px 0px 0px 0px;">
                                    ...
                                    <table width="760" bgcolor="#FFFFFF" align="center" cellspacing="0" cellpadding="4px" align="center" style="border: solid black 1px; border-collapse: collapse; background-clip:padding-box;">
                                        ...
                                        <tr>
                                            <td align="left" style="border: solid black 1px; padding-left:2px;"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px; font-weight: bold;">Цена, руб.</span><span style="color:#cc3333; font-size:10px;">*</span></td>
