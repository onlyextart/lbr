                                            ...
                                            <tr>
                                                <td style="padding: 0px 0px 0px 20px;">
                                                    <table width="358" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <img src="http://www.lbr.ru/images/kp/159-extremeLT/mail-4.jpg" width="178" style="border: 0; margin:0; float:right;" alt="Изображения не отображаются">
                                                                ...
                                                                <p style="margin:0; color:black; padding: 3px 0px 0px 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table width="760" bgcolor="#FFFFFF" align="center" cellspacing="0" cellpadding="4px" align="center" style="border: solid black 1px; border-collapse: collapse; background-clip:padding-box;">
                                            ...
                                            <tr>
                                                <td align="left" colspan="2" style="border: solid black 1px; padding-left:2px;"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px;">Цена с НДС, руб.</span><span style="color:#cc3333; font-size:10px;">*</span></td>
