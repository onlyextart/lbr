                        ...
                        <tr valign="top">
                            <td style="padding: 5px 0 0;">
                                <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                    <tr>
                                        <td style="padding: 0;">
                                            <img src="http://www.lbr.ru/images/kp/311-korm-econom/1.jpg" width="370" style="border: 0; float: left;" alt="Картинки не отображаются">
                                        </td>
                                    </tr>
                                ...
                                <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                    <tr>
                                        <td style="padding: 0;" align="center">
                                            <img src="http://www.lbr.ru/images/kp/311-korm-econom/2.jpg" width="200" style="border: 0;" alt="Картинки не отображаются">
                                        </td>
                                    </tr>
        ...
        <td>
            ...
            <!-- Ссылка-кнопка подробнее -->
                ...
                Yii::app()->getController()->renderPartial('tmpl/template/mail_more_button', array(
                    'link' => 'http://www.lbr.ru/tehnika/kormozagotovka/pritsepy-dlya-perevozki-tyukov-i-rulonov/738-telezhki-samozagruzochnye-tp-10/',
                    'colspan' => false,
