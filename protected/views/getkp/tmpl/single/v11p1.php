                ...
                <div class="content-page">
                    <div class="one-item">
                        <div class="head-content-grey">
                            <div class="h-2"><span>МТЗ 1523 - ПО СТАРОЙ ЦЕНЕ - ЭКОНОМИЯ ДО 10%</span></div>
                        </div>
                            ...
                            <div class="right-50">
                                ...
                                <table style="font-size: 13px; border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1" width="380">
                                    <tbody>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Массаэксплуатационная,кг</span>
                                        </td>
                                        <td>
                                        <span>6250</span>
                                        </td>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Размерышин (стандарт) передних колес</span>
                                        </td>
                                        <td>
                                        <span>&nbsp;420/70R24</span>
                                        </td>
...
/*    @font-face {
    ...
    .dieci-header-orange{width: 80%; font-family: FuturisXC, Calibri, sans-serif; text-transform: uppercase; font-size: 30px; display: block; border-radius: 20px; padding: 10px 20px; background: rgb(245,130,32); color: white;}
