                            ...
                            <table width="758" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: separate;">
                                <tr>
                                    <td width="30" style="width: 30px;">
                                        <img src="http://www.lbr.ru/images/makers/unia-logo-big.jpg" width="15"  style="border: 0; float: left;" alt="Нажмите отобразить рисунки"> 
                                    </td>
                                    <td width="728" style="width: 728px;">
                                        <p style="padding: 0; font-size: 16pt; font-family: Calibri; font-weight: 800; color: #333333; margin: 0; text-align: left; line-height: 15pt;">
                                            ПЛУГ ОБОРОТНЫЙ НАВЕСНОЙ | <span style="color:#f87f3e;">IBIS</span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <td style="padding: 5px 20px 5px;">
                            <table width="758" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: separate;">
                                <tr>
                                    ...
                                    <td width="728" style="width: 728px;">
                                        <p style="padding: 0; font-size: 16pt; font-family: Calibri; font-weight: 800; color: #333333; margin: 0; text-align: left; line-height: 15pt;">
                                            СТЕРНЕВОЙ КУЛЬТИВАТОР | <span style="color:#f87f3e;">KOS</span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding: 10px 10px 0px 10px;" height="443px" >
                                        ...
                                        <table width="348" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: collapse;">
                                            <tr>
                                                <td>
                                                    <img src="http://www.lbr.ru/images/kp/time_to_by_kp/july/mail-3.png" width="348" style="border: 0; float: left;" alt="Нажмите отобразить рисунки"> 
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    <td style="padding: 10px 20px 0px 20px;" height="443px">
                                        ...
                                        <table width="349" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: collapse;">
                                            <tr>
                                                <td>
                                                    <img src="http://www.lbr.ru/images/kp/time_to_by_kp/july/mail-4.png" width="349" style="border: 0; float: left;" alt="Нажмите отобразить рисунки"> 
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <tr>
                        <td style="padding: 5px 20px 5px;">
                            <table width="758" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: separate;">
                                <tr>
                                    <td width="30" style="width: 30px;">
                                        <img src="http://www.lbr.ru/images/makers/logo-czerwone-ok.jpg" width="20"  style="border: 0; float: left;" alt="Нажмите отобразить рисунки"> 
                                    </td>
                                    <td width="728" style="width: 728px;">
                                        <p style="padding: 0; font-size: 16pt; font-family: Calibri; font-weight: 800; color: #333333; margin: 0; text-align: left; line-height: 15pt;">
                                            ПРИКАТЫВАЮЩИЕ КАТКИ|<span style="color:#f87f3e;">EXPOM</span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="padding-bottom:10px;">
                                        <table width="758" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: separate;">
                                            <tr>
                                                <td rowspan="4" style="padding: 20px 0 10px;">
                                                    <img src="http://www.lbr.ru/images/kp/time_to_by_kp/july/mail-5.png" width="360" style="border:0; float: left;">
                                                </td>
                                                <td style="padding: 0 0 0 15px;" align="center">
                                                    <img src="http://www.lbr.ru/images/kp/time_to_by_kp/july/mail-6.png" width="360" style="border:0;"> 
                                                </td>
                                            ...
                                            <tr>
                                                <td style="padding: 10px 0px 10px 15px;">
                                                    <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: #333333; margin: 0; font-weight:bold; text-align: justify; line-height: 12pt;">
                                                        Катки JACEK и MAXIMUS - это готовое решение для прикатки после простых сеялок с загортачами для ускорения всходов: 
                                                    </p>
                                                </td> 
                                            </tr>
                                            <tr>
                                                <td style="padding: 10px 0 10px 15px;">
                                                    <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: #333333; margin: 0; text-align: left; line-height: 12pt; text-align: justify;">
                                                        • Дружные и равномерные всходы <br>
                                                        • Подавление сорной растительности <br>
                                                        • Экономия времени и ГСМ на дополнительные проходы другой техникой <br>
                                                        • Рост урожайности на 10-15%
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 10px 0 0 15px;">
                                                    <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: #f87f3e; margin: 0; text-align: left; line-height: 12pt; text-align: justify; font-weight:bold;">
                                ...
                                <tr>
                                    <td colspan="2" style="padding-top:10px;">
                                        <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: black; margin: 0; text-align: left; line-height: 12pt; text-align: justify;">
                                            <span style="font-weight:bold;">БОНУСНОЕ ПРИМЕНЕНИЕ:</span> катки можно успешно применять при послеуборочной обработке для ускорения процесса гниения соломы и пожнивных остатков, а также для провоцирования прорастания рассыпанных семян, в том числе сорняков.   
                                        </p>
                                    </td>
                                </tr>
                        ...
                        <td style="padding: 5px 20px 5px;">
                            <table width="758" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: separate;">
                                <tr>
                                    ...
                                    <td width="728" style="width: 728px;">
                                        <p style="padding: 0; font-size: 16pt; font-family: Calibri; font-weight: 800; color: #333333; margin: 0; text-align: left; line-height: 15pt;">
                                            РАЗБРАСЫВАТЕЛЬ УДОБРЕНИЙ | <span style="color:#f87f3e;">RCW 10 0000</span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table width="758" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: separate;">
                                            <tr valign="middle">
                                                ...
                                                <td style="padding: 20px 15px 10px 15px;" colspan="2">
                                                    <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: #f87f3e; font-weight:bold; margin: 0; text-align: left; line-height: 12pt;">
                                                        50 ГА ЗА 1 ВЫХОД В ПОЛЕ - "МИНЕРАЛКА" ПО-КРУПНОМУ!
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr valign="middle">
                                                <td style="padding: 10px 0 10px 15px;" colspan="2">
                                                    <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: #333333; margin: 0; text-align: left; line-height: 12pt; text-align: justify;">
                                                        Это позволяет на 25-30% сократить агротехнические сроки внесения минеральных удобрений.
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr valign="middle">
                                                <td style="padding: 10px 0 10px 15px;" colspan="2">
                                                    <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: #333333; margin: 0; text-align: left; line-height: 12pt; text-align: justify;">
                                                        Оптимальная загрузка МТЗ 1221 на полевых работах.
                                                    </p>
                                                </td>
                                            </tr>
                    ...
                    <tr>
                        <td style="padding: 5px 20px 5px;">
                            <table width="758" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: separate;">
                                <tr>
                                    <td width="30" style="width: 30px;">
                                        <img src="http://www.lbr.ru/images/makers/spectrukagro1.jpg" width="20"  style="border: 0; float: left;" alt="Нажмите отобразить рисунки"> 
                                    </td>
                                    <td width="728" style="width: 728px;">
                                        <p style="padding: 0; font-size: 16pt; font-family: Calibri; font-weight: 800; color: #333333; margin: 0; text-align: left; line-height: 15pt;">
                                            ГОРИЗОНТАЛЬНЫЙ СМЕСИТЕЛЬ-КОРМОРАЗДАТЧИК | <span style="color:#f87f3e;">СЕНЬОР</span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <table width="758" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF"  style="border:0; border-collapse: separate;">
                                            <tr>
                                                <td rowspan="4" style="padding: 10px 0 10px;" colspan="2" valign="top">
                                                    <img src="http://www.lbr.ru/images/kp/time_to_by_kp/july/mail-8.png" width="360" style="border:0; float: left;">
                                                </td>
                                                <td style="padding: 10px 0px 10px 15px;" colspan="2">
                                                    <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: #333333; margin: 0; text-align: justify; line-height: 12pt;">
                                                        Использование кормораздатчика СЕНЬОР для приготовления и раздачи полнорационных кормовых смесей позволяет увеличить прибыль на 20% (в отличие от раздельного кормления).
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 10px 0 10px 15px;" colspan="2">
                                                    <p style="padding: 0; font-size: 11pt; font-family: Calibri; color: #333333; margin: 0; text-align: left; line-height: 12pt; text-align: justify;">
                                                        Эти машины обеспечивают <span style="font-weight: bold;"> получение корма высочайшей степени смешивания и измельчения</span>, а сверхточная электронная система взвешивания позволяет оптимально дозировать компоненты для получения полноценных смесей. 
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
