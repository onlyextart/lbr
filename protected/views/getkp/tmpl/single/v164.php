            ...
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FECC00" align="center" style="border: 0; border-collapse: collapse; background: #FECC00;">
                            ...
                            <td style="padding: 0 10px 0 20px; text-align: left;" align="left">
                                ...
                                <td style="padding-bottom: 3px;">
                                    <!-- Заголовок -->
                                    <p style="margin: 0; font-size: 33px; text-align: center; font-weight: bolder; font-family: 'Arial Black', Arial; text-decoration: none; color: white;">
                ...
                <tr><td style="padding: 0 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td>
                                    <img src="http://www.lbr.ru/images/kp/164-agri38/1.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                                   ...
                                   <table width="700" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="center" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="28%" style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 16px; font-weight: bold; text-align: center; color: grey; border-right: 1px solid grey; border-bottom: 1px solid black; background: #FFFF99;">JCB 535-95</td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/orange-arrow.png" width="9" style="padding: 0 10px 0 0; border: 0; float: left;" alt="double-disk">
                                                        9,75</td>
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">9,51</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/orange-arrow.png" width="9" style="padding: 0 10px 0 0; border: 0; float: left;" alt="double-disk">
                                                        2200</td>
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">1600</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0 18px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">450</td><td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/yellow-arrow.png" width="9" style="padding: 0 12px 0 0; border: 0; float: left;" alt="double-disk">500</td>
                                            </tr>                                                                    
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0 18px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">6,45</td>
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">6,5</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 2px 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">8160</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/yellow-arrow.png" width="9" style="padding: 0 12px 0 0; border: 0; float: left;" alt="double-disk">82</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/yellow-arrow.png" width="9" style="padding: 0 12px 0 0; border: 0; float: left;" alt="double-disk">241</td>
                                            </tr>
                                            <tr>
