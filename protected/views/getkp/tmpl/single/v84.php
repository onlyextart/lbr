                            ...
                            <tr>
                                <td style="padding-bottom: 3px;">
                                    ...
                                    <a href="http://www.lbr.ru/tehnika/shirokozakhvatnye-tekhnologii-pochvoobrabotki-i-seva/shirokozakhvatnye-seyalki/697-pnevmaticheskie-seyalki-spartan-607/" style="font-size: 18px; font-weight: 800; font-family: 'Arial Black', Arial; text-decoration: none; color: black;">
                                        Пневматическая сеялка Spartan-607<span style="font-size: 12px; color: #2518B4; font-weight: normal;">&nbsp;(подробнее...)</span></a>
                                    </a>
                                </td>
                                <td style="padding-bottom: 3px;">
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/84-spartan/spartan.jpg" width="760" height="415" style="border: 0; float: left;" alt="Логотип Expom">
                                </td>
                            </tr>
        ...
        <td>
            ...
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                ...
                <td style="width: 380px;">
                    <img src="http://www.lbr.ru/images/kp/84-spartan/spartan3.jpg" width="378" style="border: 0; float: left;" alt="Картинки не отображаются">
                </td>
                <td style="width: 380px;">
                    <img src="http://www.lbr.ru/images/kp/84-spartan/spartan4.jpg" width="378" style="border: 0; float: left;" alt="Картинки не отображаются">
                </td>
                </tr>
                </table>
                </td>
                ...
                <tr>                    
                    <td colspan="2" style="padding: 10px 20px;">
                        <img src="http://www.lbr.ru/images/kp/84-spartan/spartan5.jpg" width="760" style="border: 0; float: left;" alt="Картинки не отображаются">
                    </td>
                </tr>
                <tr valign="top">
                <td style="padding: 10px 20px 0;">
                    ...
                    <tr>                    
                    <td style="width: 380px;">
                    <img src="http://www.lbr.ru/images/kp/84-spartan/spartan7.jpg" width="378" height="70px" style="border: 0; float: left;" alt="Картинки не отображаются">
                    </td>
                    </tr>                    
                    </tbody>
                    </table>
