                ...
                <tr><td>
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/82-summers/summers.jpg" width="760" height="300px" style="border: 0; float: left;" alt="Логотип GreatPlains">
                                </td>
                            </tr>
                    ...
                    <td style="padding-top: 10px; padding-bottom: 10px;">
                        <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    ...
                                                    <tr valign="top">                                                        
                                                        <td colspan="2" style="padding: 17px 10px 0 0;">
                                                            <img src="http://www.lbr.ru/images/kp/82-summers/summers2.jpg" width="378" height="250px"  style="border: 0; float: left;" alt="Стрелка вправо">
                                                        </td>
                                                    </tr> 
                                                    <tr valign="top">                                                        
                                                        <td colspan="2" style="padding: 17px 10px 0 0;">
                ...
                <tr><td>
                    ...
                    <td style="padding-top: 10px; padding-bottom: 10px;">
                        <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    ...
                                                    <tr valign="top">                                                        
                                                        <td colspan="2" style="padding: 17px 10px 0 0;">
                                                            <img src="http://www.lbr.ru/images/kp/82-summers/summers4.jpg" width="378" height="150px"  style="border: 0; float: left;" alt="Стрелка вправо">
                                                        </td>
                                                    </tr> 
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4;">Цена с НДС, руб.<span style="color:#cc3333; font-size:10px; font-weight: bold;">*</span></td>
                                </tr>
                                <tr>
                            ...
                            <td style="padding: 5px 10px 0px 10px;">
                             ...
                             <tr valign="top">                                                        
                                 <td colspan="2" style="padding: 10px 0 0 0;">
                                    <img src="http://www.lbr.ru/images/kp/82-summers/summers5.jpg" width="760" height="250px"  style="border: 0; float: left;" alt="Стрелка вправо">
                                 </td>
                             </tr>
