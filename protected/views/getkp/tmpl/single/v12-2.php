...
<body style="min-height: 100%;">
    ...
    <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px;">
        <tr align="right">
            <td><span style="font-family: Calibri, sans-serif; font-size:32px; font-weight: bolder; color: #d1232a;">БОЛЬШОЙ ОСЕННИЙ БОНУС !!!</span><br><span style="display:block; font-family: Calibri, sans-serif;  text-align: left; font-size:38px; font-weight: bolder; color: #d1232a; text-transform: uppercase;">Всем, кто в 2013 году купил трактор МТЗ 2022 в сети агромаркетов ЛБР, - большие осенние скидки на сельхозмашины, агрегатируемые с трактором.</span></td>
        </tr>
    </table>
     <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
