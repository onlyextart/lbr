...
/*    @font-face {
    ...
    .first-header-text{clear: both; display: block; text-transform: uppercase; color: rgb(211, 35, 42); text-align: right; font-size: 32px; padding: 0; margin:0 20px; font-family: FuturisXC, Calibri, sans-serif;}
