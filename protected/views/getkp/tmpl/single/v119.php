                                        ...
                                        <tr valign="top">
                                            <td>
                                                <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                                    ...
                                                    <tr valign="top">                                                        
                                                        <td style="padding: 10px 15px 0 0;">
                                                            <img src="http://www.lbr.ru/images/kp/119-yp/yp5.jpg" width="365" style="border: 0; float: left;" alt="double-disk">
                                                        </td>
                                                    </tr>                                                   
                                                </table>
                                            </td>
                                                ...
                                                <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                                    ...
                                                    <tr valign="top">
                                                        <td style="padding: 5px 0 0 0; text-align: justify;">
                                                            <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify; color: black; ">
                                                                В рабочем положении секции сеялки 1630F могут отклоняться до 6° вверх и до 9° вниз, позволяя точно копировать изгибы поверхности по всей ширине орудия.
                                                            </p>
                                                        </td>                                                        
                                                    </tr>
                                                    <tr valign="top">                                                        
                                                    ...
                                                    <tr valign="top">                                                        
                                                        <td style="padding: 10px 0 0 0;">
                                                            <img src="http://www.lbr.ru/images/kp/119-yp/yp10.jpg" width="380" style="border: 0; float: left;" alt="double-disk">
                                                        </td>
                                                    </tr>                                      
                                                </table>
                                            </td>
