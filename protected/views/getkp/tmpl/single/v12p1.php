        ...
        <div id="wrapper">
                ...
                <div class="content-page">
                    <div class="one-item">
                        <div class="head-content">
                            <div class="h-2 left-85"><span>Трактор «БЕЛАРУС-2022»</span></div>
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-1.jpg" border="0" />                                
                            </div>
                            <div style="position: absolute; bottom: 289px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                            ...
                            <div class="right-50">
                                <br>
                                <table style="font-size: 14px; border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1" width="380">
                                 <tbody>
                                    <tr>
                                    <td>
                                    <span>Модель</span>
                                    ...
                                    <td>
                                    <span>&laquo;Беларус-2022.3&raquo;</span>
                                    </td>
                                    </tr>
                                    <tr>
                                    <td>
                                    ...
                                    <td>
                                    <span>механическая,ступенчатая, синхронизированная, шестидиапазонная</span>
                                    </td>
                                    </tr>
                                    <tr>
                                    <td>
                                    ...
                                    <td>
                                    <span>Дизель по выбросам вредных веществ соответствует экологическим требованиям ступени TierII, кондиционер,комплектдля сдваивания задних колес в&nbsp; стандартной комплектации</span>
                                    </td>
                                    </tr>
                                    <tr>
                                           <td>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    ...
                    <div class="one-item">
                        <div class="head-content">
                            <div class="h-2 left-85"><span>Плуг оборотный Vis L 5+1</span></div>
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-2.jpg" border="0" />
                            </div>
                    ...
                    <div class="one-item">
                        <div class="head-content">
                            <div class="h-2 left-85"><span>Плуг оборотный Hektor 6</span></div>
                            <div class="logo-maker right-15"><img src="http://www.lbr.ru/images/kp/logo1.jpg" border="0" style="position: absolute; right: 0px; top: 5px; "/></div>
                        </div>
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-3.jpg" border="0" />
                            </div>
                            <div style="position: absolute; bottom: 14px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                                <div style="font-family:FuturisC, sans-serif; font-size: 20px; font-weight: bold; color: white; margin-left: 10px; margin-right: 10px;">
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    <tbody>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Размер трубы рамы,мм</span>
                                        </td>
                                        <td>
                                        <span>150х150х12</span>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Рабочая скорость движения,км/ч</span>
                                        </td>
                                        <td>
                                        <span>7-9</span>
                                        </td>
                    ...
                    <div class="one-item">
                        <div class="head-content">
                            <div class="h-2 left-85"><span>Борона дисковая Ares TXL 6,0</span></div>
                            <div class="logo-maker right-15"><img src="http://www.lbr.ru/images/kp/unia-logo.jpg" border="0" style="position: absolute; right: 0px; top: 5px; "/></div>
                        </div>
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-4.jpg" border="0" />
                            </div>
                            <div style="position: absolute; bottom: 4px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                                <div style="font-family:FuturisC, sans-serif; font-size: 20px; font-weight: bold; color: white; margin-left: 10px; margin-right: 10px;">
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    ...
                    <div class="one-item">
                        <div class="head-content">
                            <div class="h-2 left-85"><span>Культиваторы предпосевные Atlas XXL 6, 8, 9</span></div>
                            <div class="logo-maker right-15"><img src="http://www.lbr.ru/images/kp/unia-logo.jpg" border="0" style="position: absolute; right: 0px; top: 5px; "/></div>
                        </div>
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-5.jpg" border="0" />
                            </div>
                            <div style="position: absolute; bottom: 4px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                                <div style="font-family:FuturisC, sans-serif; font-size: 20px; font-weight: bold; color: white; margin-left: 10px; margin-right: 10px;">
                    ...
                    <div class="one-item">
                        <div class="head-content">
                            <div class="h-2 left-85"><span>Культиватор предпосевной Полярис-12</span></div>
                            <div class="logo-maker right-15"><img src="http://www.lbr.ru/images/kp/zirka-logo.jpg" border="0" style="position: absolute; right: 0px; top: 5px; "/></div>
                        </div>
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-6.jpg" border="0" />
                            </div>
                            <div style="position: absolute; bottom: 68px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                                <div style="font-family:FuturisC, sans-serif; font-size: 20px; font-weight: bold; color: white; margin-left: 10px; margin-right: 10px;">
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="font-size: 13.5px; border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    <tbody>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Количество зубовыхборон,шт.</span>
                                        </td>
                                        <td>
                                        <span>4</span>
                                        </td>
                                        ...
                                        <span>(длинах ширинах высота)</span>
                                        ...
                                        <span>&nbsp;</span>
                                        <span>&nbsp;</span>
                                        <span>4470х8380х1850</span>
                                        <span>4470х4220х3250</span>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Мощность трактора (неменее),л.с.</span>
                                        </td>
                                        <td>
                                        <span>150</span>
                                        </td>
                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-7.jpg" border="0" style="height: 310px;" />
                            </div>
                            <div style="position: absolute; bottom: 33px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                                <div style="font-family:FuturisC, sans-serif; font-size: 20px; font-weight: bold; color: white; margin-left: 10px; margin-right: 10px;">
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="font-size: 12px; border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    <tbody>
                                        ...
                                        <td>
                                        <span>&nbsp;Габариты:</span>
                                        <span>Транспортная ширина,мм в рабочем положении,</span>
                                        <span>длина,мм</span>
                                        <span>ширина,мм</span>
                                        <span>высота,мм</span>
                                        </td>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-8.jpg" border="0" />
                            </div>
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    <tbody>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Количество сошников,шт.</span>
                                        </td>
                                        <td>
                                        <span>78</span>
                                        </td>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Давление на сошник/давление на колтер,кг</span>
                                        </td>
                                        <td>
                                        <span>40-82/-</span>
                                        </td>
                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-9.jpg" border="0" />
                            </div>
                            <div style="position: absolute; bottom: 4px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                                <div style="font-family:FuturisC, sans-serif; font-size: 20px; font-weight: bold; color: white; margin-left: 10px; margin-right: 10px;">
                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-10.jpg" border="0" />
                            </div>
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="font-size: 13px; border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    <tbody>
                                        ...
                                        <tr>
                                        <td>
                                        <span>&nbsp;Емкость семенных ящиков,л</span>
                                        </td>
                                        <td>
                                        <span>2886л под семена и 1514л под ЖКУ</span>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-11.jpg" border="0" />
                            </div>
                            <div style="position: absolute; bottom: 98px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                                <div style="font-family:FuturisC, sans-serif; font-size: 20px; font-weight: bold; color: white; margin-left: 10px; margin-right: 10px;">
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="font-size: 13.5px; border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    <tbody>
                                        ...
                                        <td>
                                        <span>1120 л под семена и 3500 л под удобрения</span>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td>
                                        ...
                                        <tr>
                                        <td>
                                        <span>Давление на открывающий турбодиск, кг</span>
                                        </td>
                                        <td>
                                        <span>185-227(5 положений пружины)</span>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td>
                    ...
                    <div class="one-item">
                        <div class="head-content">
                            ...
                            <div class="logo-maker right-15"><img src="http://www.lbr.ru/images/kp/summers-logo.jpg" border="0" style="position: absolute; right: 0px; top: 5px; "/></div>
                        </div>
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz2022-12.jpg" border="0" style="height: 160px;" />
                            </div>
                            <div style="position: absolute; bottom: 4px; width: 361px; text-align: justify;  background: rgba(204, 51, 51, 0.8);">
                                <div style="font-family:FuturisC, sans-serif; font-size: 20px; font-weight: bold; color: white; margin-left: 10px; margin-right: 10px;">
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="font-size: 12px; border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    <tbody>
                                        ...
                                        <td>
                                        <span>Кол-во секций по 1,83 м</span>
                                        </td>
                                        <td>
                                        <span>&nbsp;Масса, кг</span>
                                        </td>
                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.lbr.ru/images/kp/mtz1523_23.jpg" border="0" style="height: 180px;" />
                            </div>
...
/*    @font-face {
    ...
    .head-first-page{margin-bottom: 20px; padding-bottom: 20px; text-align: right;  background: url('http://www.lbr.ru/images/kp/bg_mtz.jpg') white no-repeat 40px 105px;}
