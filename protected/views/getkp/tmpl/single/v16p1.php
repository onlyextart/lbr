...
/*    @font-face {
    ...
    .first-header-text{clear: both; display: block; text-transform: uppercase; color: rgb(211, 35, 42); text-align: right; font-size: 24px; padding: 0; margin:0 20px; font-family: FuturisXC, sans-serif;}
    ...
    .dieci-header-orange{width: 50%; text-align: left; font-family: FuturisXC, sans-serif; text-transform: uppercase; font-size: 36px; display: block; border-radius: 20px; padding: 10px 20px; background: rgb(245,130,32); color: white;}
