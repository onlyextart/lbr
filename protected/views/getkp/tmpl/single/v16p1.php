    ...
    <body>
        <div id="wrapper">
            ...
            <div class="one-page head-first-page">
                ...
                <div class="first-header-text">ВСЕМ, КТОВ2013 ГОДУ КУПИЛТРАКТОР МТЗ 82 В СЕТИ<br>АГРОМАРКЕТОВ ЛБР, - БОЛЬШИЕ ОСЕННИЕ СКИДКИНА<br>СЕЛЬХОЗМАШИНЫ АГРЕГАТИРУЕМЫЕ С ТРАКТОРОМ.</div>
            </div>
                        ...
                        <div class="body-content">
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    ...
                                    <tr>
                                        <td><span>Цена весенняя</span></td>
                                        <td><span>&nbsp;</span></td>
                                        <td><span>&nbsp;</span></td>
                                    </tr>
                                    <tr>
                                        <td><span>Цена осенняя</span></td>
                                        <td><span>&nbsp;</span></td>
                                        <td><span>&nbsp;</span></td>
                                    </tr>
                                    </tbody>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                <img src="http://www.git-lbr.ru/images/kp/mtz82_16.jpg" border="0" />
                            </div>
                            <div class="right-50">
                                <span class="tech-bold"><b>Технические характеристики</b></span>
                                <table width="380" style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    ...
                                    <tr>
                                    <td>
                                    <span>Рабочие обороты ВОМ, об/мин</span>
                                    </td>
                                    <td colspan="5">
                                    <span>&nbsp;540</span>
                                    </td>
                                    ...
                                    <tr>
                                    <td>
                                    <span>Расстояние между насадками распылителя, см</span>
                                    </td>
                                    <td colspan="5">
                                    <span>&nbsp;50</span>
                                    </td>
                                    ...
                                    <tr>
                                    <td>
                                    <span>Максимальна транспортная скорость, км/час</span>
                                    </td>
                                    <td colspan="5">
                                    <span>&nbsp;15</span>
                                    </td>
                                    ...
                                    <tr>
                                    <td>
                                    <span>Диапазон регулирования высоты распылителей над землей, см</span>
                                    </td>
                                    <td colspan="5">
                                    <span>&nbsp;50-170</span>
                                    </td>
...
/*    @font-face {
    ...
    .first-header-text{clear: both; display: block; text-transform: uppercase; color: rgb(211, 35, 42); text-align: right; font-size: 24px; padding: 0; margin:0 20px; font-family: FuturisXC, Calibri, sans-serif;}
    ...
    .dieci-header-orange{width: 50%; text-align: left; font-family: FuturisXC, Calibri, sans-serif; text-transform: uppercase; font-size: 36px; display: block; border-radius: 20px; padding: 10px 20px; background: rgb(245,130,32); color: white;}
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" style="font-size: 13px; border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    ...
                                    <tr>
                                           ...
                                           <td class="price">
                                           <? echo $data['price_blue28']; ?>
                                           </td>
                                           <td class="price">
                                           <? echo $data['price_blue29']; ?>
                                           </td>                                           
                                        </tr>
                                    <tr>
                                    <td>
