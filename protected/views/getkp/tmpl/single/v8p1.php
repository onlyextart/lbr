                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                ...
                                <table style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1" width="361">
                                        <tbody>
                                            <tr bgcolor="#d1d3d4">
                                                <td align="left" width="65%"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 14px;">Модель</span></td>
                                                <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 14px;">TTX 230 M/У</span></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="width-100">
                                ...
                                <table style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1" width="100%">
                                        <tbody>
                                            <tr bgcolor="#d1d3d4">
                                                <td align="left" width="65%"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 14px;">Модель</span></td>
                                                <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 14px;">Цена с НДС</span></td>
                                            </tr>
                                            <tr>
                                                <td align="left" width="35%"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 14px;">Трактор “MC TTX 230” (c механическим управлением диапазонов переключения передач) пр-во РФ</span></td>
                                                <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 14px;"><? echo $data['price1']?></span></td>
                                            </tr>
                                            <tr>
                                                <td align="left" width="35%"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 14px;">Трактор McCORMICK TTX 230 E ( с электронным управлением диапазонов переключения передач) пр-во Италия</span></td>
                                                <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 14px;"><? echo $data['price2']?></span></td>
                                            </tr>
                                        </tbody>
                                </table>
                            </div>
...
/*    @font-face {
    ...
    .first-header-text{clear: both; display: block; text-transform: uppercase; background: white; color: rgb(211, 35, 42); text-align: right; font-size: 52px; padding: 0; margin:0 20px; font-family: FuturisXC, Calibri, sans-serif;}
