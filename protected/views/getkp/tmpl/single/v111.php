            ...
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                ...
                <tr>
                    <td style="padding: 10px 20px 0;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding: 0;">
                                    <img src="http://www.lbr.ru/images/kp/111-zont/mail-1.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="margin: 0; padding: 0; line-height: 41px; font-family: 'Trebuchet MS', sans-serif; font-size: 40px; text-align: justify; color: black;">
                                        <span style="font-weight: bold; color: #f58220;">Косилки</span>
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding-left: 10px;">
                        <table width="770" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td rowspan="3" style="padding-top: 10px;">
                                    <img src="http://www.lbr.ru/images/kp/111-zont/mail-2.jpg" width="400" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                                <td style="padding: 15px 0 10px; text-align: right;" align="right">
                                    <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 17px; font-style: italic; text-align: justify; color: black;">
                                        <span style="font-weight: bold; color: #6E7071;">Покос даже по сложному профилю поля.</span>
                                    </p>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td style="padding-bottom: 3px; text-align: right;" align="right">
                                    <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; text-align: justify; color: black;">
                                        <span style="font-weight: bold; color: #f58220;">Качественное кошение всех зеленых культур:</span>
                                    </p>
                                    <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                        конструкция  косилки  обеспечивает  стабильный равномерный  срез  культуры,  скашиваемая  масса не  режется  дважды  при  работе.  В  результате  по-лучаем  отличный  готовый  продукт  без  потерь  и  с минимальной засоренностью.
                                    </p>
                                </td>
                            </tr>
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="center" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min1']; ?></td>
                                    <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min2']; ?></td>
                                    <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min3']; ?></td>
                                    <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min4']; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding-left: 10px;">
                        <table width="770" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td style="padding: 10px 15px 0; text-align: right;" align="right">
                                    <img src="http://www.lbr.ru/images/kp/default/mail-right-arrow-list.jpg" height="30" style="border: 0; float: right;" alt="Изображения не отображаются">
                                </td>
                                <td style="padding: 15px 0 0px; text-align: right;" align="right">
                                    <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 17px; font-style: italic; text-align: justify; color: black;">
                                        <span style="font-weight: bold; color: #6E7071;">Для кошения всех зеленых культур.</span>
                                    </p>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td>
                                    <img src="http://www.lbr.ru/images/kp/111-zont/mail-3.jpg" width="450" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            ...
                            <tr valign="top">
                                <td>
                                    <table width="430" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="center" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4;">D 6000 GM</td>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4;">D 7000 GM</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min5']; ?></td>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min6']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                <td style="text-align: right;" align="right">
                                    <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; text-align: justify; color: black;">
                                        <span style="font-weight: bold; color: #f58220;">Сжимание и растрескивание скошенной травы с помощью плющилки:</span> раскрывает  наружный  слой  стеблей  и  выпускает  из них  избыточную  влагу,  ускоряя  процесс сушки, при сохранении неизменной консистенции и всех питательных веществ.
                                    </p>
                                </td>
                            </tr>
                            <!-- Ссылка-кнопка подробнее -->
            ...
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                    ...
                    <td style="padding: 0 10px 5px;">
                        <table width="780" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                ...
                                <td>
                                    <p style="margin: 0; padding: 0; line-height: 41px; font-family: 'Trebuchet MS', sans-serif; font-size: 40px; text-align: justify; color: black;">
                                        <span style="font-weight: bold; color: #f58220;">Валкообразователи, обмотчики</span>
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding: 3px 0 0 5px;">
                        <table width="775" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td style="padding-right: 15px;">
                                    <table width="390" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td colspan="2">
                                                <img src="http://www.lbr.ru/images/kp/111-zont/mail-4.jpg" width="390" style="border: 0; float: left;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 10px 10px 0 15px;">
                                                <img src="http://www.lbr.ru/images/kp/default/mail-right-arrow-list.jpg" height="30" style="border: 0; float: right;" alt="Изображения не отображаются">
                                            </td>
                                            <td style="padding-top: 10px;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; font-style: italic; text-align: left; color: black;">
                                                    <span style="font-weight: bold; color: #6E7071;">Оптимальное загребание продукта. Качественные валки.</span>
                                                </p>
                                            </td>
                                        </tr>
                                        <!-- Ссылка-кнопка подробнее -->
                                    ...
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td style="padding: 10px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Пальцевые колеса</span> деликатно загребают зеленую массу, не отделяя листья, которые содержат большую часть питательных ценностей корма. В результате сгребания получаем  однородный  и  объемный  валок,  из  которого легко сформировать ровный компактный рулон. 
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 10px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Возможность переворачивания валка для просушки.</span> Любая из сторон машины может быть заблокирована в транспортировочном положении для работы только одной стороной граблей.
                                                </p>
                                            </td>
                                        </tr>
                                            ...
                                            <td style="padding: 10px 0 0;">
                                                <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="right" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Рабочая ширина, см</td>
                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Ширина валка, см</td>
                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Цена с НДС, руб.</td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min7']; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                    ...
                                    <table width="390" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td style="padding-left: 2px;">
                                                <img src="http://www.lbr.ru/images/kp/111-zont/mail-5.jpg" width="388" style="border: 0; float: left;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td style="padding: 4px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    В  отличие  от  отечественных  моделей  ступица  колеса <span style="font-weight: bold; color: #f58220;">вращается на двух подшипниках</span>, а не на капроновых втулках.
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 4px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    Вертикальное расположение рабочего колеса на независимой  подвеске  – <span style="font-weight: bold; color: #f58220;">копирование  рельефа  почвы  и качественный сбор травы.</span> 
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 4px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    Зубья  особой  изогнутой  формы  из  качественной  пружинной  стали  – <span style="font-weight: bold; color: #f58220;">работа  на  кручение  в  двух  плоскостях без поломок даже при попадании камней.</span>
                                                </p>
                                            </td>
                                        </tr>
                                            ...
                                            <td style="padding: 4px 0 0;">
                                                <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="right" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                                    <tbody>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4;">Модель</td>
                                                            <td width="90" style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4; width: 90px;">V14</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Ширина захвата, м</td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">7,62</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Количество рабочих колес</td>
                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Рабочая скорость, км/ч </td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">до 20</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Требуемая мощность трактора, л.с. </td>
                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Цена с НДС, руб.</td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min8']; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                ...
                Yii::app()->getController()->renderPartial('tmpl/template/mail_more_button', array(
                    ...
                    'colspan' => false,
                    'style' => 'text-align: right; padding: 0px 13px 0;'
                        )
                );
                ?>
                            ...
                            <tr valign="top">
                                <td style="padding-right: 15px;">
                                    <table width="390" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td style="padding-left: 2px;">
                                                <img src="http://www.lbr.ru/images/kp/111-zont/mail-6.jpg" width="388" style="border: 0; float: left;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <td style="text-align: right;" align="right">
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td style="padding: 10px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Низкое потребление мощности по сравнению с роторными граблями. 11,7 м - идеально для МТЗ 82!</span> 
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 10px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Идеальное  копирование  рельефа  поля. </span>Отсутствие запутывания зеленой массы на колес машины.
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 10px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Низкие  эксплуатационные  расходы:</span> простое  конструктивное решение, отсутствие карданных валов, отсутствие механических трансмиссий.
                                                </p>
                                            </td>
                                        </tr>
                                            ...
                                            <td style="padding: 10px 0 0;">
                                                <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="right" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                                    <tbody>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4;">Модель</td>
                                                            <td width="135" style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4; width: 135px;">Millennium V20-7GW</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Цена с НДС, руб.</td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min9']; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
            ...
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                    ...
                    <td>
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white; border-bottom: 2px solid black;">
                            <tr valign="bottom">
                                <td style="padding-bottom: 3px;">
                                    <!-- Заголовок -->
                                    <a href="http://www.lbr.ru/tehnika/kormozagotovka/obmotchiki-rulonov/380-obmotchiki-rulonov-pritsepnye-fw-10-2000-s/" style="font-size: 18px; font-weight: 800; font-family: 'Arial Black', Arial; text-decoration: none; color: black;">
                                        Обмотчик рулонов FW 36
                                    </a>
                                </td>
                                <td style="padding-bottom: 3px; text-align: right;" align="right">
                                    <img src="http://www.lbr.ru/images/kp/default/wolagri.jpg" height="30" style="border: 0; float: right;" alt="Логотип Unia">
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr valign="top">
                                <td style="padding-right: 15px;">
                                    <table width="390" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td>
                                                <img src="http://www.lbr.ru/images/kp/111-zont/mail-7.jpg" width="390" style="border: 0; float: left;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                                        <!-- Ссылка-кнопка подробнее -->
                                        <?php
                                        Yii::app()->getController()->renderPartial('tmpl/template/mail_more_button', array(
                                            'link' => 'http://www.lbr.ru/tehnika/kormozagotovka/obmotchiki-rulonov/380-obmotchiki-rulonov-pritsepnye-fw-10-2000-s/',
                                            'colspan' => false,
                                            'style' => 'text-align: right; padding: 10px 0 0;'
                                                )
                                        );
                                    ...
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td style="padding: 5px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Загрузка и обмотка рулонов без остановок</span> – прицепная конструкция с боковой загрузкой. Контроль и управление работой производится непосредственно из каби-ны трактора, что позволяет экономить время оператора.
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 5px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                                    <span style="font-weight: bold; color: #f58220;">Результат работы машины – идеально упакованный в пленку рулон для длительного хранения: </span>
                                                </p>
                                            </td>
                                        </tr>
                                            ...
                                            <td style="padding: 5px 0 0;">
                                                <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="right" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                                    <tbody>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4;">Модель</td>
                                                            <td width="90" style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background: #d1d3d4; width: 90px;">FW 36</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Макс. размер рулона (ширина и диаметр), см </td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">120 х 160</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Система разгрузки рулона </td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">задняя</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Требуемая мощность трактора, л.с.  </td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">35</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Цена с НДС, руб.</td>
                                                            <td style="margin: 0; padding: 1px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min10']; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="margin: 0; padding: 0; line-height: 44px; font-family: 'Trebuchet MS', sans-serif; font-size: 40px; text-align: justify; color: black;">
                                        <span style="font-weight: bold; color: #f58220;">Пресс-подборщики</span>
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding: 3px 0 0 0px;">
                        <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="right" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td>
                                    <img src="http://www.lbr.ru/images/kp/111-zont/mail-8.jpg" width="800" style="border: 0; float: right;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding: 10px 21px 0;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="right" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                ...
                                <td rowspan="3" style="width: 350px; padding-right: 20px;">
                                    <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; text-align: justify; font-style: italic;">
                                        <span style="font-weight: bold; color: #6E7071;">Пресс-подборщики  Колумбия  Р10  пред-назначены  для  подбора  и  прессования  в рулоны скошенной травяной массы независимо от ее влажности с обвязкой рулонов шпагатом.</span>
                                    </p>
                                </td>
                                <td>
                                    <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; text-align: justify; color: black;">
                                        <span style="font-weight: bold; color: #f58220;">Заготовка одной универсальной машиной всех видов кормов </span>– упаковка как сухого, так и влажного продукта.
                                    </p>
                                </td>
                            </tr>
                            <tr valign="top">
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="center" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; text-decoration: line-through;"><?php echo $data['price_min_blue11']; ?></td>
                                    <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; text-decoration: line-through;"><?php echo $data['price_min_blue12']; ?></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min11']; ?></td>
                                    <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min12']; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
    ...
    <tr>
        <td>
            ...
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                    ...
                    <td style="padding: 0px 20px 0;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white; border-bottom: 2px solid black;">
                            <tr valign="bottom">
                                ...
                                <td style="padding-bottom: 3px; text-align: right;" align="right">
                                    <img src="http://www.lbr.ru/images/kp/default/logo-famarol.jpg" height="30" style="border: 0; float: right;" alt="Логотип Unia">
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding: 3px 20px 0px 7px;">
                        <table width="773" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="centers" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td>
                                    <img src="http://www.lbr.ru/images/kp/111-zont/mail-9.jpg" width="773" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="right" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="top">
                                <td style="padding-right: 10px;">
                                    <table width="360" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="0" bordercolor="#808285" align="center" style="border-collapse: collapse; background: white;">
                                        <tr>
                                            <td style="padding: 0px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; text-align: justify;">
                                                    Для сбора и прессования в тюки сена и соломы.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding: 7px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; text-align: justify;">
                                                    Возможна  установка  направляющих  для  загрузки  в прицеп.
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 7px 0 0;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; text-align: left; text-transform: uppercase; color: #F58220; font-weight: 900;">
                                                    ПРОДаНО 500 еДИНИЦ За 5 ЛеТ
                                                </p>
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; text-align: left; text-transform: uppercase; color: #F58220; font-weight: 900;">
                                                    БеЗ еДИНОЙ КРИТИЧеСКОЙ ПОЛОМКИ.
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td>
                                    <table width="380" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="right" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Ширина подбора, м </td>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">1,85</td>
                                            </tr>
                                            <tr>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Длина тюка, м </td>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">0,3-1,3</td>
                                            </tr>
                                            <tr>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">Требуемая мощность, л.с.</td>
                                            ...
                                            <tr>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; color: #6E7071; border-right: 1px solid grey; border-bottom: 1px solid grey; text-decoration: line-through;">Цена обычная с НДС, руб.</td>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: center; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; text-decoration: line-through;"><?php echo $data['price_min_blue13']; ?></td>
                                            </tr>
                                            <tr>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal; text-align: left; color: #F58220; font-weight: 900; border-right: 1px solid grey; border-bottom: 1px solid grey;">ЦЕНА ПО АКЦИИ С НДС, руб.</td>
                                                <td style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 15px; font-weight: bold; text-align: center; color: #DD2A1B; border-right: 1px solid grey; border-bottom: 1px solid grey;"><?php echo $data['price_min13']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                ...
                Yii::app()->getController()->renderPartial('tmpl/template/mail_more_button', array(
                    ...
                    'colspan' => false,
                    'style' => 'text-align: right; padding: 0px 14px 0;'
                        )
                );
                ?>
                <tr>
                    <td>
                        <img src="http://www.lbr.ru/images/kp/111-zont/mail-10.jpg" width="800" style="border: 0; float: left;" alt="Изображения не отображаются">
                    </td>
                </tr>
                <tr>
                    <td style="background: #d2232a; padding: 7px 0; text-align: center;">
                        <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 18px; text-align: center; text-transform: uppercase; color: #FFFFFF; font-weight: 900;">
                            Срок действия акции с 21 апреля по 31 июля 2014 года.
                        </p>
                    </td>
                </tr>
            </table>
