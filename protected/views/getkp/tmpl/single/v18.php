                            ...
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                    ...
                                    <br />• комлект для внесения удобрений Polonez Dablo (бункер 1000 кг разделен: 600 - для семян и 400 - для удобрений) 
                                     ...
                                     <table width="328" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>                                            
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family:Calibri, sans-serif; font-size: 12px; font-weight: bold; color: rgb(211,35,42);">Цена руб с НДС</span><span style="color:#cc3333; font-size:10px;">*</span></td>
                                    ...
                                    * цена сформирована по состоянию на <?php echo date("d.m.Y") ?>
                                    ...
                                    <td align="right"><img src="http://www.lbr.ru/images/kp/disc-1.jpg" width="300" border="0" />
                                    </td>
                            ...
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                    ...
                                    * цена сформирована по состоянию на <?php echo date("d.m.Y") ?>
                                    ...
                                    <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    <td align="right"><img src="http://www.lbr.ru/images/kp/disc-2.jpg" width="300" border="0" />
                                    </td>
        ...
        <tr>
            <td>
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    ...
                    <tr><td width="638px"><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/>
        ...
        <tr>
            <td>
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    <tr>
                        <td>
                            <table width="601" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;">
                                <tr>
                                    <td><span style="font-family: Calibri, sans-serif; font-size: 18px; font-weight: bolder;">Cеялка POLONEZ/MAZUR</span></td>
                                    <td align="right"><span style="font-family: Calibri, sans-serif; font-size: 18px; font-weight: bolder;">Cеялка POLONEZ/MAZUR</span><img style="position: absolute;" src="http://www.lbr.ru/images/kp/unia-logo.jpg" border="0" /></td>
                                </tr>
                            </table>
                            <table width="601" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;">
                                <tr>
                                    <td><span style="font-family: Calibri, sans-serif; font-size: 18px; font-weight: bolder;">+КУЛЬТИВАТОР ATLAS</span></td>
                                    <td align="right"><span style="font-family: Calibri, sans-serif; font-size: 18px; font-weight: bolder;">+дискатор ARES</span></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                    <td width="315">
                                     <img style="margin-bottom: 10px;" src="http://www.lbr.ru/images/kp/disc-6.jpg" width="315" height="178px" border="0" />
                                    </td>
                                    <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    <td align="right"><img src="http://www.lbr.ru/images/kp/disc-7.jpg" width="313" height="178" border="0" />
                                    </td>
                                   <td><img src="http://www.lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                </tr>
                    ...
                    <table width="638" border="1" cellspacing="0" cellpadding="0" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        ...
                                        <td bgcolor="#d1d3d4"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><b>Cеялка Polonez 4/780 D + культиватор Atlas XXL 4,0</b></span></td>
                                        <td bgcolor="#d1d3d4"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><b>Cеялка  Mazur 6 + культиватор Atlas XXL 6,0</b></span></td>
                                        <td bgcolor="#d1d3d4"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><b>Cеялка Polonez 4/780 D + дискатор Ares TXL 4,0</b></span></td>
                                        <td bgcolor="#d1d3d4"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><b>CеялкаMazur 6 + дискатор Ares TXL 6,0</b></span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left"><span style="font-family:Calibri, sans-serif; font-size: 12px; font-weight: bold; color: rgb(211,35,42);">Цена руб с НДС</span><span style="color:#cc3333; font-size:10px;">*</span></td>
