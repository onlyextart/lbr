                    ...
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;">
                                <tr>
                                    <td><span style="font-family: Calibri, sans-serif; font-size: 18px; font-weight: bolder;">Механическая сеялка POLONEZ</span></td>
                        ...
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                     ...
                                     <table width="328" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>                                            
                                            ...
                                            <tr>
                                                ...
                                                <td><span style="font-family: Calibri, sans-serif; font-size: 12px;">31</span></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td align="right"><img src="http://www.git-lbr.ru/images/kp/seyalka.jpg" width="300" border="0" />
                                    </td>
                ...
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;">
                                <tr>
                                    <td><span style="font-family: Calibri, sans-serif; font-size: 18px; font-weight: bolder;">Механическая сеялка MAZUR</span></td>
                                    <td align="right"><img src="http://www.git-lbr.ru/images/kp/unia-logo.jpg" border="0" /></td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                    ...
                                    <br />• комплект для внесения удобрений Mazur Dablo (бункер 1 100 кг разделен: 2/3 - для семян и 1/3 - для удобрений)
                                     ...
                                     <table width="328" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Количество рядов (сошников),  шт.</span></td>
                                                <td><span style="font-family: Calibri, sans-serif; font-size: 12px;">47</span></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Емкость семенного ящика, дм3</span></td>
                                                <td style="text-align: center;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">1100</span></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Производительность, га/ч</span></td>
                                                <td style="text-align: center;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">4,8</span></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Требуемая мощность трактора, л.с.</span></td>
                                    ...
                                    <td><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    <td align="right"><img src="http://www.git-lbr.ru/images/kp/seyalka2.jpg" width="300" border="0" />
                                    </td>
                ...
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;">
                                <tr>
                                    <td><span style="font-family: Calibri, sans-serif; font-size: 18px; font-weight: bolder;">Пневматическая сеялка Master Drill D600</span></td>
                        ...
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                    ...
                                    <span style="display: block; text-align: justify; font-family:Calibri, sans-serif; font-size: 14px; color: #222222; line-height: 16px;"><b>БЫСТРО:</b>
                                        <br />• рабочая скорость до 12 км/ч 
                                    <br />• 2-х дисковый сошник - 2-ух сторонняя опора с подшипником имеет очень компактный корпус, что позволяет работать без забивания даже в тяжелых условиях. 
                                     <br />• бункер 1500 дм<sup>3</sup>
                                    </span>
                                    <span style="display: block; text-align: justify; font-family:Calibri, sans-serif; font-size: 14px; color: #222222; line-height: 16px;"><b>ТОЧНО:</b>
                                        <br />• центральная и индивидуальная регулировка давления сошников 
                                    <br />• система центрального дозирования с помощью ячейкового дозатора, для высева мелкосеменных (РАПС, травы) - устройство просто переключается.  
                                     <br />• уплотняющий каток за каждым сошником - четко ведет сошник на заданную глубину, прикатывает, улучшая контакт семени с почвой.
                                    </span>
                                    
                                     
                                    </td>
                                    <td><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    <td align="right"><img src="http://www.git-lbr.ru/images/kp/seyalka3.jpg" width="300" border="0" /><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/>
                                    <table width="300" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Количество рядов (сошников)</span></td>
                                                <td><span style="font-family: Calibri, sans-serif; font-size: 12px;">48</span></td>
                                            </tr>
                                             <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Производительность, га/ч</span></td>
                                                <td style="text-align: center;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">5,1</span></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Емкость семенного ящика, дм<sup>3</sup></span></td>
                ...
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;">
                                <tr>
                                    <td><span style="font-family: Calibri, sans-serif; font-size: 18px; font-weight: bolder;">ЗЕРНОВАЯ СЕЯЛКА SUPER DRILL D400</span></td>
                                    <td align="right"><img src="http://www.git-lbr.ru/images/kp/logo1.jpg" border="0" /></td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                    ...
                                    <span style="display: block; text-align: justify; font-family:Calibri, sans-serif; font-size: 14px; color: #222222; line-height: 16px;"><b>Преимущества: </b>
                                        <br />• незначительное подъемное усилие за счет небольшого собственного веса; 
                                    <br />• 2-х дисковые сошники, на которых используется надежная подшипниковая опора. Скребки, расположенные с обеих сторон, и крышка с верхней стороны позволяют предотвратить забивание;  
                                     <br />• большой диаметр колеса с почвозацепами обеспечивает равномерный привод вала высеивающего аппарата - точное соблюдение количества высеваемых семян.
                                    </span>
                                                                      
                                     
                                    </td>
                                    <td><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td>
                                    <td align="right"><img src="http://www.git-lbr.ru/images/kp/seyalka4.jpg" width="300" border="0" /><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/>
                                    <table width="300" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: Calibri, sans-serif; font-size: 12px;">Рабочая ширина, м</span></td>
