                ...
                <tr><td style="padding: 0 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white; border-bottom: 2px solid black;">
                            <tr>
                                ...
                                <td style="padding-bottom: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/default/mail-hydrac-logo.jpg" height="30" style="border: 0; float: right;" alt="Логотип Hudrac">
                                </td>
                            </tr>
                        </table>
                    </td></tr>
                            ...
                            <tr>
                                <td style="padding-top: 3px;">
                                    <div class="img-wrapper">
                                        <img src="http://www.lbr.ru/images/kp/profi-63/print-1.jpg" width="760" style="border: 0; float: left;" alt="Логотип Expom">
                                        <div class="orange-plash">Профессиональный подход к работе погрузчика!</div>
                    ...
                    <td style="padding: 0 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                            <tr valign="bottom">
                                ...
                                <td width="380" style="padding: 15px 0 5px;">
                                    <table width="370" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                        <tbody>
                                            <tr>
