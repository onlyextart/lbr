                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding: 15px 0;">
                                    <div class="img-wrapper">
                                        <img src="http://www.lbr.ru/images/kp/97-bellon/print-1.png" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                        <div class="orange-plash" style="font-size: 14px;">ДОСТУПНЫЙ «ПРЕМИУМ-КЛАСС» ДЛЯ ЗАГОТОВКА КОРМОВ С ТОЛСТЫМ СТЕБЛЕМ.</div>
                            ...
                            <tr>
                                <td>
                                    <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr valign="top">
                                            <td width="40" style="padding: 0px 0 10px;">
