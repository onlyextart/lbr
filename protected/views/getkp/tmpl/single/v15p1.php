                    ...
                    <div class="one-item">
                        <div class="body-content">
                            <div class="head-content">
                                <div class="h-2 left-85"><span>Сеялка культиваторного типа MaxiM ii</span></div>
                            ...
                            <div class="body-content">
                                <div class="left-50 image">
                                    <img src="http://www.git-lbr.ru/images/kp/maximka-1.jpg" border="0" />
                                    ...
                                    <table width="360" style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <span>Сеялка	культиваторного	типа	Maxim	II,	60’,	18,3м/Бункер	8370,	2-х контурная	система,	Gumbo	Boot</span>
                                                </td>
                                                <td>
                                                    <span style="font-family:FuturisC, Calibri, sans-serif; font-size: 15px; font-weight: bold; color: rgb(211,35,42);">5 490 000 руб.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>Сеялка	культиваторного	типа	Maxim	II,	40’,	12,2м/Бункер	8370,	2-х контурная	система,	Gumbo	Boot</span>
                                                </td>
                                                <td>
                                                    <span style="font-family:FuturisC, Calibri, sans-serif; font-size: 15px; font-weight: bold; color: rgb(211,35,42);">4 449 000 руб.</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="right-50" style="text-align: center;">
                                    ...
                                    <span class="text" style="font-size: 15px; line-height: 20px;">
                                        <b>Осуществляет посев всех видов культур (кроме куку-рузы на зерно):</b>
                                        <br>• осуществляет ленточный посев на ширину до 12 см под стрельчатую лапу;	однострочный	или	двухстрочный	по-сев	узкими	сошниками;
                                        <br>• внесение гранулированных	и (или) жидких	удобрений вместе с семенами или	отдельно от них;
                                        <br>• уничтожение сорняков стрельчатой лапой сплошное перекрытие.<br>
                                    </span>
                                ...
                                <div class="width-100">
                                    <span class="span-red-center" style="font-size: 17px; padding: 25px 0 20px;">
                                        Цена указана на условиях самовывоза со склада в г. Смоленск. <br> готовы предложить выгодные цены доставки до Вашего хозяйства. <br>Новые сеялки – выставочные образцы, производства 2011 года.
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    ...
                    <div class="one-item">
                        <div class="body-content">
                            <div class="left-40 image">
                                <img src="http://www.git-lbr.ru/images/kp/maximka-2.jpg" border="0" />
                            </div>
                            <div class="right-60">
                                <span class="text">
                                    <b>Сеялка культиваторного типа типа Maxim ii</b> может использоваться
                                        для легкой культивации, например, вспаханного поля. Оснащена стойками
                                        и пружинной защитой с давлением <b>180 кг</b>.<br>
                                        Копирование почвы и прикатывание с большим усилием обеспечивает
                                        равномерное прорастание и созревание посевов даже в условиях недостатка влаги.<br>
                                        ...
                                        <b>Отличием</b> сеялки является конструкция рамы, <b>вес</b> которой <b>распределяется</b> между передними сдвоенными колесами и задними прикатывающими катками, что <b>гарантирует отличное прикатывание и контакт семени с почвой.</b>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="one-item">
                        <div class="body-content">
                            <div class="left-40 image">
                                <img src="http://www.git-lbr.ru/images/kp/maximka-3.jpg" border="0" />
                            </div>
                            <div class="right-60">
                                <span class="text">
                                    <b>Пружина</b> в механизме пружинной защиты, разработанном компанией Моррис, расположена под углом к стойке и соединена с ней через рычаг-коромысло. Этот механизм запатентован. Данная конструкция позволяет сохранять постоянное давление на стойку в рабочем состоянии – <b>180 кг</b>, 
                                        при встрече стрельчатой лапы с препятствием и подъеме стойки над землей
                                        давление на нее <b>сохраняется постоянным</b>. Стойки не требуют обслуживания.<br>
                                        <b>Расстояние между стойками – 25см.</b><br>
                                        Позволяет соломе свободно проходить, не застревая между стойками, что
                                        особенно важно при культивации и посеве по минимальной технологии, когда солома остается на полях.<br>
                                        <b>Универсальный агрегат</b> – может использоваться при традиционной и
                                        минимальной обработке поля. Идеально подходит для перехода с традиционной на минимальную обработку почвы. В течение одного сезона выравнивает рельеф полей.
                                        <b>Заменяет Вам несколько сеялок, культиваторов, разбрасывателей.</b><br>
                                        <b>Позволяет экономить удобрения</b> и увеличивает эффект от их внесения за счет расположения с зерном или в непосредственной близости от него.
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="one-item">
                        <div class="body-content">
                            <div class="left-40 image">
                                <img src="http://www.git-lbr.ru/images/kp/maximka-4.jpg" border="0" />
                            </div>
                            <div class="right-60">
                                <span class="text">
                                    Сеялка оборудована раздельной системой внесения семян и удобрений, ко-торая состоит из второго контура труб и распределителей, сошников Gumbo
                                    boot для раздельного внесения удобрений, состоящих из твердосплавных
                                    сменных наконечников и сменных пластин. С таким сошником сеялка оказы-вает минимальное воздействие на почву и позволяет закладывать основную
                                    дозу минеральных удобрений ниже уровня семян, а семена располагаются в
                                    две строчки по разные стороны удобрений.
                                </span>
                                
                                <span class="text"><b>Особенности сошника Gumbo boot:</b><br><br>
                                    <br>• Семяпроводы расположены сзади	сошника, в один	ряд
                                    <br>• Раздельное внесение	семян и	удобрений
                                    <br>• Заменямость
                                    <br>• Размещение позади сошника для долговечности
                                </span>
                            </div>
                        </div>
                    </div>
...
/*    @font-face {
    ...
    .dieci-header-orange{width: 80%; font-family: FuturisXC, Calibri, sans-serif; text-transform: uppercase; font-size: 48px; display: block; border-radius: 20px; padding: 10px 20px; background: rgb(245,130,32); color: white;}
