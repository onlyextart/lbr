        ...
        <div id="wrapper">
            <div id="header">
                <div class="left-75 header-text">
                    <span class="header-1"> Уважаемый Николай Семенович<? echo $data['client']; ?>!</span>
                    <span class="header-2">В продолжение нашего разговора высылаю коммерческое предложение по заинтересовавшей Вас технике. Готов ответить на любые дополнительные вопросы и помочь с выбором <? echo $data['header']; ?> </span></div>
                <div class="right-20">
                            ...
                            <table style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid; position: absolute; right: 0; top: 260px;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1" width="380">
                                    <tbody>
                                        <tr bgcolor="#d1d3d4">
                                            ...
                                            <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">«Беларус-1221.2»</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Двигатель</span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">Д-260.2</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Мощность, кВт (л.с.) </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">96 (130)</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Число передач: вперед/назад </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">16/8</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Грузоподъемность гидронавесной системы на оси подвеса, кг </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">4300</span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price4}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                        </div>
                        ...
                        <div class="body-content">
                            ...
                            <div class="right-50">
                                ...
                                <table width="380" cellspacing="0" cellpadding="0" align="left" border="1" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;">
                                    <tr bgcolor="#d1d3d4">
                                        <td width="50%" align="left"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">&nbsp;Модель</span></td>
                                        <td width="25%" align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">ТУР-16</span></td>
                                        <td width="25%" align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">ТУР-17</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left" width="70%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Грузоподъемность, кг</span></td>
                                        <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; "> 1 700</span></td>
                                        <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">2 350</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">&nbsp;Цена руб с НДС</span></td>
                                        <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price1}</span></td>
                                        <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price2}</span></td>
                                    </tr>
                                </table>
                            </div>
                            <div class="width-100 image">
                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            <div class="left-50 image">
                                ...
                                <span class="text" style="margin-top: 0; font-family:FuturisXC, Calibri, sans-serif;">Высота погрузки всего 1,13 метра!</span>
                                <span class="h-4" style="font-size:13px;">ПРИВЛЕКАТЕЛЬНАЯ ЦЕНА. ВСЕГДА В НАЛИЧИИ! –</span>
                                <span class="text" style="margin-top: 0; padding-right: 10px; font-family:FuturisXC, Calibri, sans-serif;">на 10% дешевле импортных аналогов, идеальное соотношение цена-качество.</span>
                            </div>
                            <div class="right-50">
                                <span class="text" style="font-family:FuturisXC, Calibri, sans-serif; font-size: 16px;">                                    
                                ...
                                <table style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1" width="380">
                                    <tbody>
                                        <tr bgcolor="#d1d3d4">
                                            <td align="left" width="60%"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">&nbsp;Модель</span></td>
                                            <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">Баркас 10</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Грузоподъемность, кг </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">8000</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Размер платформы, м </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">4,41х2,11х0,6</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Габаритные размеры, мм<br>&nbsp;- длина<br>&nbsp;- ширина</span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; "><br>6058<br>2320</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Высота платформы, мм </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">1200</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Высота с одним ярусом бортов, мм </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">1800</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Высота с двумя ярусами бортов, мм </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">2400</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Гидравлическая разгрузка  </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">трехсторонняя</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">&nbsp;Цена руб с НДС</span></td>
                                            <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price3}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="right-50">
                                ...
                                <table style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1" width="380">
                                    <tbody>
                                        <tr bgcolor="#d1d3d4">
                                            <td align="left" width="60%"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">&nbsp;Модель</span></td>
                                            <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">Баркас XL</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Грузоподъёмность, кг</span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">10 000</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Масса , кг </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">1 260</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Размер платформы, м </span></td>
                                            <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">5 Х2,4 х 0,6</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="60%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Шины, сдвоенные </span></td>
                        ...
                        <div class="body-content">
                            ...
                            <div class="width-100">
                                <table width="500" cellspacing="0" cellpadding="0" align="left" border="1" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid;">
                                    <tr bgcolor="#d1d3d4">
                                        <td width="50%" align="left"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">&nbsp;Модель</span></td>
                                        <td width="25%" align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">LMR 10</span></td>
                                        <td width="25%" align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">LMR 14</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left" width="70%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Грузоподъемность, т</span></td>
                                    ...
                                    <tr>
                                        <td align="left" width="70%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Объем кузова с двумя ярусами надставных бортов, куб. м</span></td>
                                    ...
                                    <tr>
                                        <td align="left" width="70%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Собственная масса, кг </span></td>
                                    ...
                                    <tr>
                                        <td align="left" width="70%"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">&nbsp;Скорость транспортировки, км/ч </span></td>
                                        <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">30</span></td>
                                        <td align="center"><span style="font-family: Calibri, sans-serif; font-size: 12px; ">30</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">&nbsp;Цена руб с НДС</span></td>
                                        <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price5}</span></td>
                                        <td align="center"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price6}</span></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
...
/*    @font-face {
    ...
    .first-header-text{display: block; text-transform: uppercase; background: rgb(211, 35, 42); color: white; text-align: center; font-size: 72px; padding: 0; font-family: FuturisXC, Calibri, sans-serif;}
    .second-header-text{display: block; text-align: right; color: rgb(211, 35, 42);  text-transform: uppercase; font-size: 42px; font-family: FuturisXC, Calibri, sans-serif; margin-bottom: 15px; margin-top: 5px}
    ...
    .orange-text-right{margin-top: 15px; font-family: FuturisXC, Calibri, sans-serif; font-size: 27px; padding:3px 5px; text-transform: uppercase; padding: 5px 10px; background: rgb(245,130,32); color: white; text-align: right;}
