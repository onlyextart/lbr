    ...
    <tr>
        <td>
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/313-evp24/2.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#f0eeee" align="center" style="border: 0; border-collapse: collapse; background:#f0eeee;">
                            <tr>
                                <td colspan="2" width="370" valign="top" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                        Интенсивная качественная почвообработка за один
                                        проход - измельчает, разрыхляет и выравнивает
                                        почву перед посевом.
                                    </p>
                                ...
                                <td colspan="2" width="370" valign="top" style="padding: 10px 20px 5px 20px; text-align: left;">
                                     <p style="margin:0; color: black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                         Полное копирование рельефа благодаря тандемной
                                         колесной системе. После прохода культиватора по
                                         полю полное отсутствие гребней, глыб, следов.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/313-evp24/3.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#f0eeee" align="center" style="border: 0; border-collapse: collapse; background:#f0eeee;">
                            <tr>
                                <td colspan="2" width="370" valign="top" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                        Выравнивание гребней, рыхление и финишное
                                        выравнивание почвы. В процессе работы агрегата
                                        обеспечивается плавное копирование поверхности
                                        и рельефа поля.
                                    </p>
                                ...
                                <td colspan="2" width="370" valign="top" style="padding: 10px 20px 5px 20px; text-align: left;">
                                     <p style="margin:0; color: black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                         Интенсивное крошение пласта, подрезка сорняков,
                                         измельчение растительных остатков, дробление
                                         комков, выравнивание и уплотнение почвы.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/313-evp24/4.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#f0eeee" align="center" style="border: 0; border-collapse: collapse; background:#f0eeee;">
                            <tr>
                                <td colspan="2" width="370" valign="top" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                        Точный и равномерный посев. Конструкция
                                        позволяет высевать и зерновые, и мелкосемянные
                                        культуры без замены катушки.
                                    </p>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/313-evp24/5.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#f0eeee" align="center" style="border: 0; border-collapse: collapse; background:#f0eeee;">
                            <tr>
                                <td colspan="2" width="370" valign="top" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                        Высокое качество обработки почвы: стабильный
                                        оборот пласта, точная заделка растительных
                                        остатков, уменьшенное сопротивление при
                                        вспашке.
                                    </p>
                                ...
                                <td colspan="2" width="370" valign="top" style="padding: 10px 20px 5px 20px; text-align: left;">
                                     <p style="margin:0; color: black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                         Идеален для применения в небольших хозяйствах.
                                         Плуг предназначен для агрегатирования с самыми
                                         простыми и недорогими тракторами мощностью
                                         от 60&nbsp;л.с.
                                    </p>
                                </td>
                            </tr>
                ...
                <tr>
                    <td style="padding: 30px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/313-evp24/banner1.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
