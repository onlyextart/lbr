            ...
            <div class="one-page head-first-page">
                <div class="content-page">
                    <div class="dieci-header">
                        <span class="dieci-header-orange">Когда 6 метров = 12 метров,<br />когда 9 метров = 18 метров…</span>
                    </div>
                    <span class="second-header-text">Сеялки Spartan ОТ GREAT<br />PLAINS – двойная<br />производительность</span>
                </div>
            </div>
                    ...
                    <div class="one-item">                        
                        ...
                        <div style="width: 100%; height: 20px;"></div>
                            <div class="width-100">
                                ...
                                <div class="right-50">
                                    <span class="h-4" style="text-align: left; text-transform: uppercase;">Двойная экономия при той же производительности:</span>
                                    ...
                                    Себестоимость гектара при сроке эксплуатации 10 лет - 250 рублей.
                                     ...
                                     <span class="h-4" style="text-align: left; text-transform: uppercase;"><br /><br />ПЛЮСЫ:</span>
                ...
                <div class="content-page">
                    <div style="width: 100%; height: 20px;"></div>
                        <div class="one-item">
                            ...
                            <div class="body-content">
                            <div class="width-100">
                                 <span class="h-4" style="text-align: left; text-transform: uppercase;">1. Переходить на ноль стало ПРОЩЕ!</span>
                                    ...
                                    <span class="h-4" style="text-align: left; text-transform: uppercase;">2. Пропашной сошник на зерновой сеялке!</span>
             ...
             <div style="width: 100%; height: 20px;"></div>
                <div class="content-page">
                    <div class="one-item">                        
                        <div class="body-content">
                            <div class="width-100">
                                 <span class="h-4" style="text-align: left; text-transform: uppercase;">4. По любой дороге!</span>
                            ...
                            <table width="760" border="1" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        ...
                                        <tr>
                                            <td width="50%"><span style="font-family:FuturisC, sans-serif; font-size: 14px;">Рабочая ширина, м</span></td>
                                            <td width="25%"><span style="font-family:FuturisC, sans-serif; font-size: 14px;">6</span></td>
                                            <td width="25%"><span style="font-family:FuturisC, sans-serif; font-size: 14px;">9</span></td>
                                        </tr>
                                        <tr>
                                            <td><span style="font-family:FuturisC, sans-serif; font-size: 14px;">Требуемая мощность трактора, л.с.</span></td>
                                            <td><span style="font-family:FuturisC, sans-serif; font-size: 14px;">от 170</span></td>
...
/*    @font-face {
    ...
    .text-red{display: block; font-family: FuturisXC, sans-serif; color:rgb(211, 35, 42); margin-top: 8px; margin: 20px; font-size: 21px; text-align: center;}
