                    ...
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            ...
                            <table width="760" style="border-collapse: collapse; height: 1px; border-bottom: 1px black solid; font-size: 13px;" align="left" bgcolor="#FFFFFF" border="1" cellpadding="0" cellspacing="0" height="1">
                                    ...
                                    <td width="10%"><span style="font-family:FuturisC,  sans-serif; font-size: 15px; font-weight: bold; color: rgb(211,35,42);"><? echo $data['price1']; ?></span></td>
                                    <td width="15%" rowspan="3">Объем - 1,0 м<sup>3</sup></td>
                                    <td width="10%" rowspan="3"><span style="font-family:FuturisC,  sans-serif; font-size: 15px; font-weight: bold; color: rgb(211,35,42);"><? echo $data['price6']; ?></span></td>
                                    <td width="15%" rowspan="5">Объем  - 1,7 м<sup>3</sup></td>
                                    <td width="10%" rowspan="5"><span style="font-family:FuturisC,  sans-serif; font-size: 15px; font-weight: bold; color: rgb(211,35,42);"><? echo $data['price8']; ?></span></td>
                                    <td width="15%" rowspan="5">Объем  - 1,0 м<sup>3</sup></td>
                                    <td width="10%" rowspan="5"><span style="font-family:FuturisC,  sans-serif; font-size: 15px; font-weight: bold; color: rgb(211,35,42);"><? echo $data['price9']; ?></span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <td rowspan="2"><span style="font-family:FuturisC,  sans-serif; font-size: 15px; font-weight: bold; color: rgb(211,35,42);"><? echo $data['price7']; ?></span></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="one-item">
                       ...
                       <div class="width-100 image">
                           ...
                           <table style="border-collapse: collapse; height: 1px; border-bottom-width: 1px; border-bottom-color: black; border-bottom-style: solid; font-size: 13px; width: 760px;" border="1" cellspacing="0" cellpadding="0" align="left" bgcolor="#FFFFFF">
                                ...
                                <td rowspan="2" width="10%"><span style="font-family: FuturisC,  sans-serif; font-size: 15px; text-align: center; font-weight: bold; color: #d3232a;"><? echo $data['price27']; ?></span></td>
                                </tr>
                                <tr>
