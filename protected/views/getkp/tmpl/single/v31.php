        ...
        <tr>
            <td>
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    ...
                    <tr><td><img src="http://www.git-lbr.ru/images/kp/seyalki-plains.jpg" width="638" border="0" /></td></tr>
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                   ...
                                   Все это выделяет сеялки Great Plains из многих других. Рабочая ширина сеялки – 9 метров, требуемая мощность – от 140 л.с. Сеялка оборудована системой внесения удобрений и маркерами.</p>
                                    </span>
       ...
       <tr>
            <td>
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    ...
                    <tr><td><img src="http://www.git-lbr.ru/images/kp/seyalki-plains1.jpg" width="638" border="0" /></td></tr>
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr><td><img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/></td></tr>
                                ...
                                <td width="328">                                        
                                    ...
                                    <td>
                                    <img src="http://www.git-lbr.ru/images/kp/seyalki-plains2.jpg" width="300" border="0" />
                                    <img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/>
                                    <img src="http://www.git-lbr.ru/images/kp/seyalki-plains3.jpg" width="300" border="0" />
                                    <img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/>
                                    <img src="http://www.git-lbr.ru/images/kp/seyalki-plains4.jpg" width="300" border="0" />
                                    </td>
                                    </tr>
                                    <tr>
                                    <table>
                                    ...
                                    <td width="200"><img style="margin-bottom: 10px;" style="margin-bottom: 10px;" src="http://www.git-lbr.ru/images/kp/seyalki-plains5.jpg" width="200" border="0" />
                                    <img src="http://www.git-lbr.ru/images/kp/10.gif" style="display: block;"/>
                                    <img src="http://www.git-lbr.ru/images/kp/seyalki-plains6.jpg" width="200" border="0" />
                                    </td>                                   
                                    </tr></table></tr>
                                    <tr>
                                    <td colspan="2">                                    
        ...
        <tr>
            <td>
                <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                    ...
                    <tr><td><img src="http://www.git-lbr.ru/images/kp/seyalki-plains7.jpg" width="638" border="0" /></td></tr>
                    <tr>
                        <td>
                            <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; ">
                                <tr valign="top">
                                ...
                                <table width="638" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285; margin-top: 10px;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="background-color: #d1d3d4;">
                                                <td width="28%" style="text-align: left;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong>Модель</strong></span></td>
                                                <td width="12%" style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong>2SF30</strong></span></td>
                                                <td width="12%" style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong>2S-2600</strong></span></td>
                                                <td width="12%" style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong>3S-3000</strong></span></td>
                                                <td width="12%" style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong>3S-4000</strong></span></td>
                                                <td width="12%" style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong>3S-5000</strong></span></td>
