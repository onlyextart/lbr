                            ...
                            <div class="width-100">
                               <table width="380" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt; text-align: left;">&nbsp;Колеса, мм</span></td>
                                                <td style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">512 x144</span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family:FuturisC, sans-serif; font-size: 12px; font-weight: bold; text-align: left;display:inline;padding-right: 0px;">&nbsp;Цена руб, с НДС</span><span style="color:#cc3333; font-size:12px;padding-left: 0px;display:inline;">*</span></td>
            ...
            <div class="one-page body-page">
                            ...
                            <div class="width-100">
                                ...
                                <table width="380" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><span style="font-family:FuturisC, sans-serif; font-size: 12px; font-weight: bold; text-align: left;display:inline;padding-right: 0px;">&nbsp;Цена руб, с НДС</span><span style="color:#cc3333; font-size:12px;display:inline;padding-left: 0px;">*</span></td>
                ...
                <div class="one-item">
                        ...
                        <div class="body-content">
                            ...
                            <div class="width-100">
                                <span class="h-4" style="text-transform: uppercase;">2. Высокая высота выгрузки!</span>
                                <span class="text">
                                   Высота выгрузки комбайна составляет 3,3 метра, что позволяет использовать транспортное средство с большим объемом кузова.
                                </span>
                            </div>
                            <div class="width-100">
                                <span class="h-4" style="text-transform: uppercase;">3. Отличная визуализация!</span>
                                <span class="text">
                                ...
                                <table width="380" border="1" cellspacing="0" cellpadding="0" align="left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong><strong>Свыше 25</strong></strong></span></td>
                                            </tr>
                                            <tr>
