        ...
        <div id="wrapper">
            ...
            <div class="one-page head-first-page">
                <div class="dieci-header">
                    <span class="dieci-header-orange">Трактор McCORMICK TTX 230, 230 л.с<br /> +<br /> американский посевной комплекс<br /> шириной захвата 13,7 метра</span>
                </div>
                    ...
                    <div class="one-item">
                        <div class="body-content">
                            ...
                            <div class="body-content">                                
                                ...
                                <div class="right-40" style="text-align: center; margin-top: 15px;">
                                    ...
                                    <span class="span-red-left" style="color: black;"><br/>НИЗКИЕ ЭКСПЛУАТАЦИОННЫЕ РАСХОДЫ.</span>
                                    <span class="span-red-left" style="color: black;"><br/>МИНИМУМ ВРЕМЕНИ НА ПРОВЕДЕНИЕ ТО.</span>
                            ...
                            <table width="760" border="1" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        ...
                                        <tr>
                                            <td><span style="font-family:FuturisC, sans-serif; font-size: 14px;">Трактор «MC TTX 230» (c механическим управлением диапазонов переключения передач)</span></td>
                        ...
                        <div class="body-content">
                            ...
                            <div class="body-content">
                                ...
                                <div class="width-100" style="text-align: center;">
                                    <span class="span-red-left">1. КЛАССИЧЕСКИЙ УНИВЕРСАЛ</span>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    <div style="width: 100%; height: 20px;"></div>
                        ...
                        <div class="body-content">                            
                            <div class="body-content">                                                               
                                ...
                                <div class="left-50"> 
                                            <table width="406" border="1" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="left"><span>Количество дисковых сошников</span></td>
                                            <td><span>90</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left"><span>Диаметр дисков, см</span></td>
                                            <td><span>35,6</span></td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                                <span>Прикатывающие колеса, см</span>
                                            </td>
                                            <td>
                                                <span>35,6 x 7,6</span>
                                            </td>
                                        </tr> 
                                        <tr>
                                            <td align="left">
                                                <span>Система контроля высева</span>
                                            </td>
                                            <td>
                    ...
                    <div style="width: 100%; height: 20px;"></div>
                      <div class="dieci-header">
                    <span class="dieci-header-orange">В наличии 5 тракторов и 5 посевных комплексов, предложение ограничено!</span>
                </div>                          
                    <div class="footer">
