                    ...
                    <td style="padding:30px 20px 5px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                            ...
                                            <td width="100" valign="top" style="padding:0px 0px 0px 15px;">
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/304-evp23/2.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#e1e1df" align="center" style="border: 0; border-collapse: collapse; background:#e1e1df;">
                           <tr>
                                <td  width="380" valign="top" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align:left; ">
                                        Интенсивно обрабатывает почву и разрушает комки
                                        земли, что способствует повышению производительности
                                        при дальнейших работах. Машина прекрасно работает
                                        даже на песчаных почвах, сохраняя хорошую скорость.
                                    </p>

                                </td>
                                <td width="360" valign="top" style="padding: 10px 20px 5px 20px; text-align: left;">
                    ...
                    <td style="padding:20px 20px 5px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                            ...
                                            <td width="90" valign="top" style="padding:0px 0px 0px 15px;">
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/304-evp23/3.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding:0px 20px 20px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#e1e1df" align="center" style="border: 0; border-collapse: collapse; background:#e1e1df;">
                            <tr>
                                <td width="380" valign="top" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                        Посадка картофеля с междурядьями 70, 75 и 90 см.,
                                        возможность одновременного протравливания клубней и
                                        внесения минеральных удобрений. Комплектуется
                                        высаживающими аппаратами немецкой фирмы GRIMME.
                                    </p>

                                </td>
                                <td width="360" valign="top" style="padding: 10px 20px 5px 20px; text-align: left;">
                                     <p style="margin:0; color: black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                         Более высокая точность посева, за счет диска диаметром 22 мм.
                                         Расположение высевающих элементов в шахматном порядке
                                         позволяет производить высев в две строчки и изменять
                                         расстояние от 4 до 9 см.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/304-evp23/4.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#e1e1df" align="center" style="border: 0; border-collapse: collapse; background:#e1e1df;">
                            <tr>
                                <td width="380" valign="top" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                        Специальная система подвески позволяет идеально
                                        копировать рельеф. Обеспечивает качественное
                                        рыхление почвы в междурядьях на заданную глубину и
                                        одновременно уничтожает сорняки.
                                    </p>

                                </td>
                                <td width="360" valign="top" style="padding: 10px 20px 5px 20px; text-align: left;">
                                     <p style="margin:0; color: black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                         Все форсунки опрыскивателя находятся в глубине штанги, что
                                         исключает их случайное повреждение и забивание.
                                         Опрыскиватели оборудованы специальной системой
                                         стабилизации штанги, что позволяет минимизировать колебания
                                         во время движения.
                                    </p>
                                </td>
                            </tr>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/304-evp23/5.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#e1e1df" align="center" style="border: 0; border-collapse: collapse; background:#e1e1df;">
                            <tr>
                                <td width="380" valign="top" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; text-align: left; ">
                                        Гашение колебаний штанги благодаря оборудованию
                                        опрыскивателя маятниковой системой и параллелограмным
                ...
                <tr>
                    <td style="padding: 20px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/304-evp23/banner2_header.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
