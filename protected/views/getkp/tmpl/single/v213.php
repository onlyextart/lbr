                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="padding:10px 0px 0px 0px;">
                                                            <p style="margin:0; color:#F58220; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold;text-align: justify; ">
                                                                ...
                                                                <span style="color:#000000">посев, как в сухую, так и во влажную почву благодаря конструкции сошников.</span>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td valign="top"style="padding:10px 0px 0px 0px;">
                                                ...
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight:normal;text-align: justify; ">
                                                    ...
                                                    щих сошников с центральной регулировкой глубины
...
<!--                                        <tr valign="top">
  ...
  <!-- Ссылка-кнопка подробнее -->
                ...
                Yii::app()->getController()->renderPartial('tmpl/template/mail_more_button', array(
                    'link' => 'http://www.lbr.ru/tehnika/klassicheskie-tekhnologii-pochvoobrabotki-i-seva/posevnye-kombinatsii-i-agregaty/594-posevnaya-kombinatsiya-atlas-polonez/',
                    'colspan' => false,
