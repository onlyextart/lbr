                                    ...
                                    <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td style="padding:0px 0px 0px 5px;" width="350">
                                                            <p style="margin: 0; padding: 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; color: #58595d; text-align: justify; font-style:italic;">
                                                                Навесной морковоуборочный комбайн тере-
                                                                бильного типа производства компании Simon
                                        ...
                                        <tr>
                                            <td>
                                                <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    <tr valign="top">
                                                        <td width="20" align="left" style="padding:10px 0px 5px 0px;">
                                                            •
                                                        </td>
                                                        <td style="padding:10px 0px 5px 0px;" valign="top">
                                                            <p style="margin: 0; padding: 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; color: black; text-align: justify;">
                                                                Расположенный в нижней части комбайна лемех бе-
                                                                режно подкапывает морковь, облегчая ее вытягивание за ботву.
                                                            </p> 
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <td width="20" align="left" style="padding:5px 0px 5px 0px;" valign="top">
                                                            •
                                                        </td>
                                    ...
                                    <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td style="padding-left: 20px; padding-bottom: 10px;">
                                                <img src="http://www.lbr.ru/images/kp/151-morkov/mail-3.jpg" width="358" style="border: 0; float:right;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-left: 20px; padding-bottom: 10px;">
                                                <img src="http://www.lbr.ru/images/kp/151-morkov/mail-4.jpg" width="358" style="border: 0; float:right;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                                        ...
                                        <tr valign="top">
                                            <td>
                                                ...
                                                <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    <tr>
                                                        <td style="padding: 5px 0px 5px 0px;">
                                                            <p style="margin: 0; padding: 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; color: black; text-align: justify;">
                                                                <span style="font-weight: bold; color:#F58220;">Навесной комбайн для уборки моркови S2TCMR </span> –
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                                <tr>
                                                                    <td style="padding: 5px 0px 5px 0px;" width="150">
                                                                        <img src="http://www.lbr.ru/images/kp/151-morkov/mail-5.jpg" width="150" style="border: 0; float:right;" alt="Изображения не отображаются">
                                                                    </td>
                                                                    <td style="padding: 5px 0px 5px 15px;" width="228">
                                                                        <img src="http://www.lbr.ru/images/kp/151-morkov/mail-6.jpg" width="213" style="border: 0; float:right;" alt="Изображения не отображаются">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                            ...
                                            <td>
                                                <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    <tr>
                                                        <td style="padding-left: 20px; padding-bottom: 10px;">
                                                            <img src="http://www.lbr.ru/images/kp/151-morkov/mail-7.jpg" width="358" style="border: 0; float:right;" alt="Изображения не отображаются">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0px 5px 20px;">
                                                            <p style="margin: 0; padding: 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal; color: black; text-align: justify;">
                                                                <span style="font-weight: bold;">Устройство для подбора лука </span>(опция), позволяет под-
                                                                бирать лук с рядка, максимальной шириной 1м, что де-
                                                                лает данный комбайн универсальным помощником для
                                                                сельского хозяйства.
                                                            </p>
                                                        </td>
                                                    </tr>
