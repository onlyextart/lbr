                            ...
                            <tr>
                                <td style="padding-bottom: 3px;">
                                    ...
                                    <a href="http://www.lbr.ru/tehnika/shirokozakhvatnye-tekhnologii-pochvoobrabotki-i-seva/shirokozakhvatnye-seyalki/697-pnevmaticheskie-seyalki-spartan-607/" style="font-size: 18px; font-weight: 800; font-family: 'Arial Black', Arial; text-decoration: none; color: black;">
                                        Пневматическая пропашная селка точного высева YP-825A<span style="font-size: 12px; color: #2518B4; font-weight: normal;">&nbsp;(подробнее...)</span></a>
                                    </a>
                                </td>
                                <td style="padding-bottom: 3px;">
                            ...
                            <tr valign="top">
                                    ...
                                    <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                      <tr valign="top">                                                        
                                                    ...
                                                    <tr valign="top">                                                        
                                                     ...
                                                     <tr valign="top">                                                        
                                                        <td colspan="2" style="padding: 17px 10px 0 0;">
                                                           <img src="http://www.lbr.ru/images/kp/83-YP825/yp825-6.jpg" width="378" height="300px" style="border: 0; float: left;" alt="Картинки не отображаются">
                                                        </td>
                                                    </tr>
                                                    </table>
                                </td>
                                <td style="padding: 10px 0 0;">
                                    <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    ...
                                                    <tr valign="top">                                                        
                                                        <td style="padding: 17px 0 0 0;">
                                                           <img src="http://www.lbr.ru/images/kp/83-YP825/yp825-7.jpg" width="378" style="border: 0; float: left;" alt="Картинки не отображаются">
                                                        </td>
                                                    </tr>
                                                    </table>
                                </td>
