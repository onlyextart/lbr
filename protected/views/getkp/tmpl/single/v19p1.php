        ...
        <div id="wrapper">
            ...
            <div class="one-page head-first-page">
                <div class="dieci-header">
                    <span class="dieci-header-orange"><span class="span-align-left">Профессиональный сев пропашных</span><span class="span-align-right">культур по-американски!</span></span>
                </div>
                
                <div class="first-header-text">Выгодные подсолнечник <br />и кукуруза - <br />современный подход <br />к посеву!</div>
            </div>
            <div class="one-page body-first-page">
                <div class="content-page">
                    <div class="head-content">
                        <div class="h-2"><span>1. Прицепная 8-ми рядная сеялка точного высева <br />Great Plains PD-8070 с механическими высевающими аппаратами</span></div>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    ...
                    <div class="one-item">
                        <div class="head-content">
                            <div class="h-2"><span style="font-size: 18px;">3.3. Прицепная 24-х рядная пропашная сеялка точного высева Great<br /> Plains YP-2425F с механическими высевающими аппаратами</span></div>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    <div class="one-item">
                        <div class="head-content">
                            <div class="h-2"><span style="font-size: 18px;">3.4. Прицепная 24-х рядная пропашная сеялка точного высева Great<br /> Plains YP-2425А с пневматическим высевающим аппаратом и ЖКУ</span></div>
...
/*    @font-face {
    ...
    .first-header-text{display: block; text-transform: uppercase; color: rgb(211, 35, 42); text-align: right; font-size: 48px; padding: 0; margin:0 20px; font-family: FuturisXC, Calibri, sans-serif;}
    ...
    .head-content {font-family: FuturisXC, Calibri, sans-serif; margin-top: 8px; font-size: 20px;}
    ...
    .h-2 {font-family: FuturisXC, Calibri, sans-serif; margin-top: 8px; font-size: 18px;}
    ...
    .dieci-header-orange{font-family: FuturisXC, Calibri, sans-serif; font-size: 34px; display: block; border-radius: 20px; padding: 10px 20px; background: rgb(245,130,32); color: white;}
    .span-align-left{display: block; text-align: left; text-transform: uppercase;}
    .span-align-right{display: block; text-align: right; text-transform: uppercase;}
