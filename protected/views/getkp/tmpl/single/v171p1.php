                                    ...
                                    <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                        ...
                                        <tr>
                                            <td style="padding:15px 0px 0px 0px;">
                                                <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">  
                                                    <tr>
                                                        <td width="90" style="padding:0px 0px 0px 5px;">
                                                            <img src="http://www.lbr.ru/images/kp/171-Max/mail-2.jpg" width="90" style="border: 0; float: left;" alt="Изображения не отображаются">
                                                        </td>
                                                        <td width="268" style="padding:0px 0px 0px 5px;" valign="middle">
                                       ...
                                       <tr>
                                            <td>
                                                <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">  
                                                    <tr>
                                                        <td width="90" style="padding:0px 0px 0px 5px;">
                                                            <img src="http://www.lbr.ru/images/kp/171-Max/mail-3.jpg" width="90" style="border: 0; float: left;" alt="Изображения не отображаются">
                                                        </td>
                                                        <td width="268" style="padding:0px 0px 0px 5px;" valign="middle">
                                                            <p style="margin:0; color:black; padding: 5px 0px 0px 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify;">
                                        ...
                                        <tr>
                                            <td>
                                                <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">  
                                                    <tr>
                                                        <td width="90" style="padding:0px 0px 0px 5px;">
                                                            <img src="http://www.lbr.ru/images/kp/171-Max/mail-4.jpg" width="90" style="border: 0; float: left;" alt="Изображения не отображаются">
                                                        </td>
                                                        <td width="268" style="padding:0px 0px 0px 5px;" valign="middle">
                                                            <p style="margin:0; color:black; padding: 5px 0px 0px 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify;">
                ...
                <tr valign="top">
                   <td colspan="2" style="padding:10px 0px 0px 0px;">
                                    ...
                                    <table width="760" bgcolor="#FFFFFF" align="center" cellspacing="0" cellpadding="4px" align="center" style="border: solid black 1px; border-collapse: collapse; background-clip:padding-box;">
                                        ...
                                        <tr>
                                            <td align="left" style="border: solid black 1px; padding-left:2px;"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px; color:grey;">Цена с НДС</span><span style="color:red; font-size:10px;">*</span></td>
