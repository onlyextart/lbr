        ...
        <div id="wrapper">
            ...
            <div class="one-page head-first-page">
                <div class="dieci-header">
                    <span class="dieci-header-orange"><span class="span-align-left">ПРИГЛАШАЕМ ПОСЕТИТЬ</span><span class="span-align-right">ЭКСПОЗИЦИЮ ТЕХНИКИ!</span></span>
                </div>
                        ...
                        <div class="width-100">
                            ...
                            <table width="758" border="1" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                    ...
                                    <tr>                                       
                                        ...
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price1}</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price2}</span></td>
                                    </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="content-page">
                    <div class="one-item">
                        ...
                        <div class="body-content">
                            ...
                            <div class="right-60">
                                <span class="text">
                                    • Надежный ремонтопригодный двигатель IVECO с интеркулером мощностью 127 л.с.
                                    <br>• Гидростатическая трансмиссия – плавность движений и точность при погрузо-разгрузочных работах.
                                    <br>• Уникальная гидравлика рулевого управления имеет 3 режима работы: координированное управление передними колесами, поворотом всех колес в одном направлени (крабовый ход) или передних и задних в разные стороны (колея в колею).
                                    <br>• Механизм, предотвращающий опрокидывание машины при резких движениях.
                                </span>
                            </div>
                            <div class="width-100">
                                <table width="758" border="1" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                    ...
                                    <tr>                                       
                                        <td align="left"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">&nbsp;Цена руб с НДС</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price3}</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price4}</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price5}</span></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                            ...
                            <div class="left-70 image">
                                ...
                                <table width="505" border="1" cellspacing="0" cellpadding="0" align=left" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; text-align: center; vertical-align: middle; border-color: #808285;">
                                    <tr bgcolor="#d1d3d4">
                                        ...
                                        <td width="25%"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">Agri Tech 35.7 VS</span></td>
                                        <td width="25%"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 13px;">Agri Tech 32.9 VS</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px; font-weight: bold;">&nbsp;Максимальная высота подъема, м</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px; font-weight: bold;">7</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px; font-weight: bold;">9</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Максимальная грузоподъемность, кг</span></td>
                                    ...
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Грузоподъемность на максимальной высоте, кг </span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">2500</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">1500</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Мощность механического ВОМа, л.с.</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">100</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">100</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Грузоподъемность задней трехточечной навески, кг</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">4000</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">4000</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Двигатель (марка, мощность), кВт/л.с. </span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 12px;">Iveko, 93/127</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 12px;">Iveko, 93/127</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Трансмиссия</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 12px; ">Vario System</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 12px; ">Vario System</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Гидравлическая система (производительность), л/мин; бар</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 12px; ">110/240</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 12px; ">110/240</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Эксплуатационная масса, кг </span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">7.600</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">7.800</span></td>
                                    </tr>
                                    <tr>
                                        <td align="left"><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">&nbsp;Габариты (длина х ширина х высота), мм </span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">5550х2400х2500</span></td>
                                        <td><span style="font-family:FuturisC, Calibri, sans-serif; font-size: 12px;">5550х2400х2500</span></td>
                                    </tr>
                                    <tr>                                       
                                        <td align="left"><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">&nbsp;Цена руб с НДС</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price6}</span></td>
                                        <td><span style="font-family:FuturisXC, Calibri, sans-serif; font-size: 15px; color: rgb(211,35,42);">{price7}</span></td>
                                    </tr>
                            </table>
                            </div>
                            <div class="right-30">
                                <span class="text">
                                    • Инновационная трансмиссия «Vario System», имеющая 4 режима работы.
                                    <br>• Новая и высокоэффективная механическая система управления отбором мощности с двумя скоростями (540 и 1000 оборотов в минуту) и мощностью 100 л.с. может передавать всю имеющуюся мощность к приспособлениям.
                                    <br>• Трехточечная навеска с силовым и позиционным регулированием (аналогичная устанавливается на трактора New Holland) последнего поколения грузоподъемностью 4 тонны позволяет использовать телескопический погрузчик вместо трактора.
                                    <br>• Бак с дизельным топливом на 140 литров и оптимизированное потребление гарантируют рекордную автономность, что означает уменьшение остановок для дозаправки на 20-30%.
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="one-page body-page">
                <div class="content-page">
                    <div style="height: 5px; width: 100%; background: white;"></div>
                    <div class="dieci-orange width-100">
                        ВО ВСЕХ ТЕЛЕСКОПИЧЕСКИХ ПОГРУЗЧИКАХ DIECI<br> ОБЕСПЕЧИВАЕТСЯ:
                    </div>
                    <div class="body-content">
                        <div class="left-70">
                            <span class="h-4">ОБЗОР 360°</span>
                            <span class="text">
                                С приподнятого водительского сиденья обеспечивается видимость на 360° благодаря инновационной системе защиты от падений, расположенной внутри салона. Стеклоочиститель в форме параллелограмма очищает переднее стекло в верхней части кабины. Два независимых зеркала заднего вида с обеих сторон уменьшают до минимума непросматриваемые углы.                                 
                            </span>
                            <div style="height: 5px; width: 100%; background: white;"></div>
                            <span class="h-4">ЗАБОТА ОБ ОПЕРАТОРЕ!</span>
                            <span class="text">
                                Самая большая дверь среди аналогичной продукции обеспечивает легкий доступ к водительскому месту. Внутри салона все служит для облегчения работы оператора. Благодаря подлокотнику на правой панели, достигается наилучший доступ к джойстику. Звуконепроницаемость, регулируемый по высоте и глубине руль, электрический стеклоподъемник, кондиционер - все это позволяет работать оператору в условиях полного комфорта.
                            </span>
                            <div style="height: 5px; width: 100%; background: white;"></div>
                            <span class="h-4">МАКСИМАЛЬНАЯ БЕЗОПАСНОСТЬ</span>
                            <span class="text">
                                Для обеспечения максимальной безопасности все машины оборудованы электронной системой, позволяющей держать под постоянным контролем нагрузку на вилы или на другое оборудование во время работы. Ограничитель нагрузки обеспечивает гибкое и точное управление как серийным, так и специальным оборудованием.
                            </span>
                        </div>
...
/*    @font-face {
    ...
    .first-header-text{display: block; text-transform: uppercase; background: rgb(211, 35, 42); color: white; text-align: center; font-size: 48px; padding: 0; margin:0 20px; font-family: FuturisXC, Calibri, sans-serif;}
    ...
    .dieci-header-orange{font-family: FuturisXC, Calibri, sans-serif; font-size: 36px; display: block; border-radius: 20px; padding: 10px 20px; background: rgb(245,130,32); color: white;}
    ...
    .left-10, .left-20, .left-30, .left-40, .left-50, .left-60, .left-70, .left-80, .left-90, .left-75, .left-65
    {
        float: left;
    }
