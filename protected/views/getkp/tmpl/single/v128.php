            ...
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                ...
                <tr><td style="padding: 0 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td>
                                    <img src="http://www.lbr.ru/images/kp/122-dieci/2.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                                   ...
                                   <table width="700" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="center" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="28%" style="margin: 0; padding: 2px 6px; font-family: 'Trebuchet MS', sans-serif; font-size: 16px; font-weight: bold; text-align: center; color: grey; border-right: 1px solid grey; border-bottom: 1px solid black; background: #99CC00;">CLAAS Scorpion 7030</td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/orange-arrow.png" width="9" style="padding: 0 10px 0 0; border: 0; float: left;" alt="double-disk">
                                                        3700</td>
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">3300 <span style="font-size: 12px;">без противовеса</span></td>
                                            </tr>
                                             <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/orange-arrow.png" width="9" style="padding: 0 10px 0 0; border: 0; float: left;" alt="double-disk">
                                                        7,35</td>
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">7,1</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/orange-arrow.png" width="9" style="padding: 0 10px 0 0; border: 0; float: left;" alt="double-disk">3500</td>
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">2400 <span style="font-size: 12px;">без противовеса</span></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/orange-arrow.png" width="9" style="padding: 0 10px 0 0; border: 0; float: left;" alt="double-disk">1100</td>
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">1000 <span style="font-size: 12px;">без противовеса</span></td>
                                            </tr>                                                                    
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/orange-arrow.png" width="9" style="padding: 0 10px 0 0; border: 0; float: left;" alt="double-disk">
                                                        4</td>
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">3,75</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/green-arrow.png" width="9" style="padding: 0 12px 0 0; border: 0; float: left;" alt="double-disk">3600</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 2px 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">7200</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/green-arrow.png" width="9" style="padding: 0 12px 0 0; border: 0; float: left;" alt="double-disk">40</td>
                                            </tr>
                                             <tr>
                                                ...
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">160</td>
                                                <td style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;"><img src="http://www.lbr.ru/images/kp/122-dieci/green-arrow.png" width="9" style="padding: 0 12px 0 0; border: 0; float: left;" alt="double-disk">190</td>
                                            </tr>
                                             <tr>
                                                ...
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">100</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="margin: 0; padding: 0 20px; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey;">VARIO</td>
                                            </tr>                                             
                                             <tr>
