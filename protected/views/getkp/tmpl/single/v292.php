    ...
    <tr>
        <td>
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/292-evp19/2.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#background: #e7e7e7;" align="center" style="border: 0; border-collapse: collapse; background:#e7e7e7;">
                            <tr>
                                <td width="380" valign="middle" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal; text-align: justify; ">
                                        Два высевающих бункера объемом по 3500 литров.
                                        Транспортная ширина всего 3 метра.
                                    </p>
                                ...
                                <td width="360" valign="middle" style="padding: 10px 20px 5px 20px; text-align: left; width: 390px;">
                                     <p style="margin:0; color: black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal; text-align: left; ">
                                         Большой объем бункера - 12 333 л. Посев 35-40 га на
                                         одной загрузке.
                                    </p>
                                </td>
                            </tr>
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/292-evp19/3.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#background: #e7e7e7;" align="center" style="border: 0; border-collapse: collapse; background:#e7e7e7;">
                            <tr>
                                <td width="380" valign="middle" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal; text-align: justify; ">
                                        Сверхобъемные бункеры в своем сегменте от 3 000 л.,
                                        дисковый сошник большого размера со смещением.
                                    </p>

                                </td>
                                <td width="360" valign="middle" style="padding: 10px 20px 5px 20px; text-align: left; width: 390px;">
                                     <p style="margin:0; color: black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal; text-align: left; ">
                                         Вертикальная обработка почвы.<br>
                                         В два раза выше производительность в сравнении с
                                         традиционными дисковыми боронами и культиваторами.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td style="padding:30px 20px 5px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                            ...
                                            <td width="50" valign="middle" style="padding:0px 0px 0px 0px;">
                ...
                <tr>
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            <tr>
                                <td style="padding-top: 3px;">
                                    <img src="http://www.lbr.ru/images/kp/292-evp19/4.jpg" width="760" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding:0px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="background: #e7e7e7;" align="center" style="border: 0; border-collapse: collapse; background:#e7e7e7;">
                            <tr>
                                <td width="380" valign="middle" style="border-right:20px solid white; padding: 10px 20px 5px 20px">
                                    <p style="margin:0; color: black;  font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal; text-align: justify; ">
                                        Высокая производительность - до 1000 га в день.
                                        Возможность оборудования штанг воздушными
                                        рукавами.
                                    </p>
                                ...
                                <td width="360" valign="middle" style="padding: 10px 20px 5px 20px; text-align: left; width: 390px;">
                                     <p style="margin:0; color: black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 14px; font-weight: normal; text-align: left; ">
                                         Скорость выгрузки 15,4 куб.м. за минуту! Конструкция
                                         бункера-перегрузчика обеспечивает его полную
                                         разгрузку.
                                    </p>
                                </td>
                            </tr>
