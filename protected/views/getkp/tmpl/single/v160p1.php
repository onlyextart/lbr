                                    ...
                                    <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td>
                                                ...
                                                <p style="margin:0; color:black; padding: 3px 0px 0px 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal;text-align: justify; ">
                                        ...
                                        <tr valign="bottom">
                                            <td style="padding: 0px 0px 0px 0px;">
                                                ...
                                                <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal;text-align: justify; ">
                                                    ...
                                                    1) изменяемый диаметр рулона от 0,5 до 1,8м (в зависимости от модели);<br>
                                                    2) изменяемая плотность прессования рулона:
                                                </p>
                                                <img src="http://www.lbr.ru/images/kp/160-extremeHT/mail-3.jpg" width="230" style="vertical-align: bottom; border: 0; float: right;" alt="Изображения не отображаются">
                                                
                                                    
                                                    <p style="margin:0; color:black; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: normal;text-align: justify; ">

                                                    • в центральной части рулона<br>
                                                ...
                                                <table width="358" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            ...
                                                            <img src="http://www.lbr.ru/images/kp/160-extremeHT/mail-4.jpg" width="178" style="border: 0; float: right;" alt="Изображения не отображаются">
                                                            ...
                                                            <p style="margin:0; color:black; padding: 5px 0px 0px 0px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify;">
                                                                Опционально можно уста-новить подборщик с шириной 2 200 мм.
                                                            </p>  
                                                        </td>
                            ...
                            <tr valign="top">
                                ...
                                <td valign="top">
                                    ...
                                    <table width="378" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">
                                        ...
                                        <tr>
                                            <td style="padding:0px 0px 0px 10px;">
                                                <img src="http://www.lbr.ru/images/kp/160-extremeHT/mail-12.jpg" width="368" style="border: 0; float: right;" alt="Изображения не отображаются">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding:0px 0px 0px 10px;">
                                                <table width="368" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" valign="top" align="top" style="border: 0; border-collapse: collapse; background: white;">  
                                                    <tr>
                                                        ...
                                                        <td width="139" style="padding:5px 0px 0px 10px;" valign="top">
                                                            <img src="http://www.lbr.ru/images/kp/160-extremeHT/mail-13.jpg" width="139" style="border: 0; float: right;" alt="Изображения не отображаются">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="760" bgcolor="#FFFFFF" align="center" cellspacing="0" cellpadding="4px" align="center" style="border: solid black 1px; border-collapse: collapse; background-clip:padding-box;">
                                        ...
                                        <tr>
                                            <td align="left" colspan="2" style="border: solid black 1px; padding-left:2px;"><span style="font-family:'Trebuchet MS', sans-serif; font-size: 12px; color:grey;">Цена с НДС, руб.</span><span style="color:#cc3333; font-size:10px;">*</span></td>
