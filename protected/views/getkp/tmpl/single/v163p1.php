                ...
                <tr><td style="padding: 0 20px;">
                    ...
                    <tr><td style="padding: 0;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            ...
                            <tr valign="top">
                                <td width="700" style="padding: 0; text-align: center;">
            ...
            <table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                 <tr><td style="padding: 0 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            ...
                            <tr valign="top">
                                <td width="760" style="padding: 0; text-align: center;">
                                    <img src="http://www.lbr.ru/images/kp/163-dieci/razvorot.jpg" width="760" height="420" style="border: 0;" alt="Изображения не отображаются">
                                </td>
                            </tr> 
                        </table>
                    </td></tr>
                                ...
                                <td width="380" style="padding-left: 10px; max-height: 876px;">
                                    <table width="360" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="left" style="border: 0; border-collapse: collapse; background: white;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 0 10px 0 30px;">
                                                <p style="margin: 0; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; text-align: justify; color: black; ">
                                                   Компанией Dieci при проектировании своей продукции
                                                    всегда уделялось большое внимание дизайну.
                                                    Об этом отношении наглядно демонстрируют
                                                    реализация новой кабины и рестайлинг шасси.
                                                    Внимание, с которым специалисты компании Dieci
                                                    относятся к потребностям клиентов, позволило им
                                                    создать просторную и эргономическую кабину с
                                                    привлекательными линиями.
                                                </p>
                                            </td>
                                        </tr>  
                                        <tr>
