                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white; border-bottom: 2px solid black;">
                            <tr>
                                ...
                                <td style="padding-bottom: 3px; text-align: right;" align="right">
                                    <img src="http://www.lbr.ru/images/makers/amity-for-site.JPG" width="70" style="border: 0; float: right;" alt="Логотип Amity">
                                </td>
                            </tr>
                        </table>
                    </td></tr>
                ...
                <tr>
                    <td style="padding: 15px 20px 0px 20px;">
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            ...
                            <tr valign="top">
                                <td width="370">
                                    <img src="http://www.lbr.ru/images/kp/117-wil-rich/mail-3.jpg" width="370" style="border: 0; float: left;" alt="Изображения не отображаются">           
                                </td>
                                <td width="370" style="padding-left:20px;">
                                    <img src="http://www.lbr.ru/images/kp/117-wil-rich/mail-4.jpg" width="370" style="border: 0; float: left;" alt="Изображения не отображаются">
                                </td>    
