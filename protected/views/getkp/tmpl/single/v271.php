                        ...
                        <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                            ...
                            <tr>
                                <td style="padding: 20px 0px 10px 0px;">
                                    <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td>
                                                <p style="margin: 0px; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 16px; text-align:justify; color: black;line-height:20px; font-weight:bold; ">
                            ...
                            <tr>
                                <td style="padding: 5px 0px 10px 0px;">
                                    <table width="760" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="border: 0; border-collapse: collapse; background: white;">
                                        <tr>
                                            <td width="240" style="padding:0px 50px 0px 5px; vertical-align: top;">
                                                <p style="margin: 0px; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 16px; text-align:justify; color: black;line-height:20px; font-weight:bold; ">
                                                    Загрузка корма –
                                                    до 2 т
                                                </p>
                                            </td>
                                            <td width="240" style="padding:0px 50px 0px 0px; vertical-align: top;">
                                                <p style="margin: 0px; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 16px; text-align:justify; color: black;line-height:20px; font-weight:bold; ">
                                                    Объем – 5,66 м<sup>3</sup>
                                                </p>
                                            </td>
                                            <td width="150" style="padding:0px 10px 0px 15px; vertical-align: top;">
                                                <p style="margin: 0px; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 16px; text-align:justify; color: black;line-height:20px; font-weight:bold; ">
                                                    Агрегатирование с
                                                    тракторами тягового
                                                    класса 1,4 тс
                                            ...
                                            <td width="120" style="padding-right:50px;vertical-align: top;">
                                                <p style="margin: 0px; padding: 0; font-family: 'Trebuchet MS', sans-serif; font-size: 16px; text-align:justify; color: black;line-height:20px; font-weight:bold; ">
                                                    Подача в кормушки
                                                </p>
                                            </td>
                    ...
                    <td  style="padding: 10px 20px 0;">
                        <table width="700" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="1" bordercolor="#808285" align="center" style="border-collapse: collapse; background: white; border-left: 1px solid grey; border-top: 1px solid grey; border-color:  #808285;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="margin: 0; padding: 3px 7px; font-family: 'Trebuchet MS', sans-serif; font-size: 13px; font-weight: bold; text-align: left; color: black; border-right: 1px solid grey; border-bottom: 1px solid grey; background-color: #d9dada;background-clip: padding-box;">Цена с НДС, руб.<span style="color:#cc3333; font-size:12px;">*</span></td>
