...
<body style="min-height: 100%;">
    <table width="638" cellspacing="0" cellpadding="0" align="center" height="1" bgcolor="#FFFFFF"  style="border-collapse: collapse; height: 1px; page-break-after: always; ">
        <tr>
            <td><span>Австрийский пакет решений</span><span style="font-size:48px; font-weight: bolder; color: rgb(211, 35, 42); text-transform: uppercase;">для обработки<br>почвы</span></td>
            <td></td>
            <td></td>
        </tr>
    </table>
