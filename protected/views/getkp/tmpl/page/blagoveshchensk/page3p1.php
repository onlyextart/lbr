                ...
                <ul class="main-content-row">
                    <li style="width: 776px">
                        <div class="content">
                            ...
                            <div style="margin-top: 25px; font-size: 12pt;" align="justify">
                                Мы расширили ассортимент продаваемой техники и рады Вам представить наш новый
                                каталог на 2015 год.
                            </div>
                            <div style="margin-top: 23px; font-size: 12pt; color:#f29313; text-transform: uppercase; font-style: italic; font-weight: bold;" align="justify">
                            ...
                            <div style="margin-top: 32px; font-size: 12pt;" align="justify">
                        ...
                        <div class="content" style="margin-top: 71px; margin-bottom: 97px;">
                            <ul class="main-content-row">
                                <li style="">
                                    <img src="http://www.lbr.ru/images/kp/lbr-photo-blagoveschensk.jpg" height="146px" alt="Logo" style="border: 0;"/>
                                </li>
