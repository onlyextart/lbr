                ...
                <ul class="main-content-row">
                    <li style="width: 588px">
                        ...
                        <div class="content" style="margin-top: 91px; margin-bottom: 110px;">
                            <ul class="main-content-row">
                                <li style="">
                                    <img src="http://www.lbr.ru/images/kp/lbr-photo-samara2.jpg" height="146px" alt="Logo" style="border: 0;"/>
                                </li>
                                <li style="vertical-align: bottom;">
                                    <div style="margin-left: 31px; font-size: 9pt; position: relative">
                                        <div style="">C уважением, <br/> директор Самарского АгроМаркета ЛБР</div>
                    ...
                    <li style="width: 207px; vertical-align: top; background-color: #efefef;">
                        <div class="sidebar">
                            ...
                            <div class="event-content">
                                Поволжская агропромышленная неделя<br/><span style="font-size: 7pt">Международная специализированная выставка</span>
                            </div>
