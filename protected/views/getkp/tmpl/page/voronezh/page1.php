                ...
                <ul class="main-content-row">
                    <li style="width: 588px">
                        ...
                        <div class="content" style="margin-top: 71px; margin-bottom: 97px;">
                            <ul class="main-content-row">
                                <li style="">
                                    <img src="http://git-lbr.ru/images/kp/lbr-photo-voronezh.jpg" height="146px" alt="Logo" style="border: 0;"/>
                                </li>
                                <li style="vertical-align: bottom;">
                                    <div style="margin-left: 31px; font-size: 9pt; position: relative">
                                        <div style="">C уважением, <br/> И.О. Директора Воронежского АгроМаркета ЛБР</div>
