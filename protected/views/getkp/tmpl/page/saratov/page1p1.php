                ...
                <ul class="main-content-row">
                    <li style="width: 588px">
                        ...
                        <div class="content" style="margin-top: 71px; margin-bottom: 97px;">
                            <ul class="main-content-row">
                                <li style="">
                                    <img src="http://www.lbr.ru/images/kp/lbr-photo-saratov.jpg" height="146px" alt="Logo" style="border: 0;"/>
                                </li>
                    ...
                    <li style="width: 207px; vertical-align: top; background-color: #efefef;">
                        <div class="sidebar">
                            ...
                            <div class="event-content">
                                Саратов-Агро. День поля. <br/><span style="font-size: 7pt">5-й Сельскохозяйственный форум</span>
                            </div>
