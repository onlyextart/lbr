                ...
                <ul class="main-content-row">
                    <li style="width: 776px">
                        <div class="content">
                            ...
                            <div style="margin-top: 15px; font-size: 12pt; color:#f29313; text-transform: uppercase; font-style: italic; font-weight: bold;" align="justify">
                            ...
                            <div style="margin-top: 40px; font-size: 12pt;" align="justify">
                        ...
                        <div class="content" style="margin-top: 71px; margin-bottom: 97px;">
                            <ul class="main-content-row">
                                <li style="">
                                    <img src="http://www.lbr.ru/images/kp/lbr-photo-belgorod.jpg" height="146px" alt="Logo" style="border: 0;"/>
                                </li>
