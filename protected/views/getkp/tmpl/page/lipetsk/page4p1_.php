                ...
                <ul class="main-content-row">
                    <li style="width: 776px">
                        <div class="content">
                            ...
                            <div style="margin-top: 20px; font-size: 12pt; color:#f29313; text-transform: uppercase; font-style: italic; font-weight: bold;" align="justify">
                                СЕГОДНЯ ЛБР – ЭТО:
                            </div>
                        ...
                        <div class="content" style="margin-top: 65px; margin-bottom: 87px;">
                            <ul class="main-content-row">
                                <li style="">
                                    <img src="http://www.lbr.ru/images/kp/lbr-photo-lipetsk.jpg" height="146px" alt="Logo" style="border: 0;"/>
                                </li>
                                <li style="vertical-align: bottom;">
                                    <div style="margin-left: 31px; font-size: 12pt; position: relative">
                                        <div style="">C уважением, <br/> региональный управляющий по ЦФО АгроМаркета ЛБР</div>
