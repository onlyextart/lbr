                ...
                <ul class="main-content-row">
                    <li style="width: 776px">
                        <div class="content">
                            ...
                            <div style="margin-top: 44px; font-size: 12pt;" align="justify">
                        ...
                        <div class="content" style="margin-top: 65px; margin-bottom: 81px;">
                            <ul class="main-content-row">
                                <li style="">
                                    <img src="http://www.lbr.ru/images/kp/lbr-photo-smolensk2.jpg" height="146px" alt="Logo" style="border: 0;"/>
                                </li>
                                <li style="vertical-align: bottom;">
                                    <div style="margin-left: 31px; font-size: 12pt; position: relative">
                                        <div style="">C уважением, <br/> директор Смоленского АгроМаркета ЛБР</div>
