                ...
                <ul class="main-content-row">
                    <li style="width: 776px">
                        ...
                        <div class="content" style="margin-top: 71px; margin-bottom: 97px;">
                            <ul class="main-content-row">
                                <li style="">
                                    <img src="http://www.lbr.ru/images/kp/lbr-photo-krasnodar.jpg" height="146px" alt="Logo" style="border: 0;"/>
                                </li>
                                <li style="vertical-align: bottom;">
                                    <div style="margin-left: 31px; font-size: 12pt; position: relative">
                                        <div style="">C уважением, <br/> директор Краснодарского АгроМаркета ЛБР</div>
