...
<ul class="mightiness-menu">
    <li val="80-120">
        <div><img height="63" src="<?php echo Yii::app()->request->baseUrl; ?>/images/mightiness/menu_img.png"/></div>
        <div class="dir">
            для 80 л.с.
        </div>
    </li>
    ...
    <li val="350-1000">
        <div><img height="63" src="<?php echo Yii::app()->request->baseUrl; ?>/images/mightiness/menu_img.png"/><div style="clear: both"></div></div>
        <div class="dir">
            свыше 350 л.с.
        </div>
    </li>
